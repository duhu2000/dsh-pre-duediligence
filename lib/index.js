...
function compareFacts(leftId, rightId, facts, materials) {
  ...
  return { id: `C-${randomUUID()}`, leftId, rightId, status, independence: "not-established", createdAt: (/* @__PURE__ */ new Date()).toISOString() };
}
...
function registerPrevisitTools(ctx, workflow = new PrevisitWorkflowStore(), files = new ReportFiles()) {
