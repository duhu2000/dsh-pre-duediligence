...
import { type WorkspaceNavigation } from "./ordinary-session-guard.js";
import { type WorkbenchStatus } from "./workbench-state.js";
import { type CardInsights, type ToolEvent } from "./stage-insights.js";
...
export declare function OpportunityPanel(props: {
...
export declare function RiskPanel(props: {
    task: ActiveTask | undefined;
    hostedTask: HostedTask | null;
    status: WorkbenchStatus;
    events: ToolEvent[];
