...
function useImageImport(sessionId, send) {
  const accepting = (0, import_react2.useRef)(false);
  const [busy, setBusy] = (0, import_react2.useState)(false);
  const [command, setCommand] = (0, import_react2.useState)(null);
...
function ImportButton(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { ref: input, type: "file", accept: IMAGE_ACCEPT.join(","), hidden: true, onChange: (event) => {
      props.onFile(event.target.files?.[0]);
      event.target.value = "";
    } }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("button", { type: "button", className: "qccImportBtn", disabled: props.busy, title: props.title ?? "\u5BFC\u5165\u5546\u673A\u56FE\u7247\u6216 PDF\uFF08\u4E5F\u53EF\u4EE5\u76F4\u63A5\u62D6\u5165\u6216\u7C98\u8D34\uFF09", onClick: () => input.current?.click(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M21 12.5 12.5 21a5.5 5.5 0 0 1-7.8-7.8L14 3.9a3.7 3.7 0 0 1 5.2 5.2L9.9 18.4a1.8 1.8 0 0 1-2.6-2.6l8.3-8.3" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: props.busy ? "\u6682\u5B58\u4E2D\u2026" : "\u5BFC\u5165\u56FE\u7247" })
    ] })
  ] });
}
...
function usePrevisitComposer(args) {
  ...
  const state = (0, import_react3.useSyncExternalStore)(store.subscribe, () => store.get(sessionId), () => EMPTY_SESSION_STATE);
  const [error, setError] = (0, import_react3.useState)();
  const [submitting, setSubmitting] = (0, import_react3.useState)(false);
  const lifetime = (0, import_react3.useRef)({ active: true });
  const inFlight = (0, import_react3.useRef)(false);
...
function PrevisitFields(props) {
  ...
  const st = a.state;
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(DropZone, { className: "qccDockBody", onFile: (file) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccDockRow", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccDockCompanyRow", children: [
        ...
        props.send === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ImportButton, { busy: imports.busy, onFile: (file) => {
          void imports.accept(file);
        } })
      ] })
    ] }),
    imports.status === void 0 && imports.error === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "qccImportState", role: "status", "data-state": imports.error === void 0 ? imports.command?.state : "failed", children: imports.error ?? imports.status }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccDockRow", children: [
...
function PromptDialog(props) {
  ...
  const closeRef = (0, import_react4.useRef)(props.onClose);
...
function PrevisitPromptGenerator(props) {
  ...
  const [company, setCompany] = (0, import_react4.useState)("");
  const [selection, setSelection] = (0, import_react4.useState)(() => cloneSelection(EMPTY_SELECTION));
  const [initializedSession, setInitializedSession] = (0, import_react4.useState)();
  const [error, setError] = (0, import_react4.useState)();
  const [conflict, setConflict] = (0, import_react4.useState)(false);
  const triggerRef = (0, import_react4.useRef)(null);
  const previousSession = (0, import_react4.useRef)(props.sessionId);
  (0, import_react4.useEffect)(() => {
...
function useWorkbenchReveal(controller, props) {
  ...
  (0, import_react5.useEffect)(() => controller.attach(sessionId, { store, tabId }), [controller, sessionId, store, tabId]);
}
...
function LeftSidebarEntry(props) {
  const [mount, setMount] = (0, import_react6.useState)(null);
...
function PrevisitHome({ sessionId, useSession, openWorkbench: openWorkbench2 }) {
  ...
  const marker = (0, import_react7.useRef)(null);
  const [menuMount, setMenuMount] = (0, import_react7.useState)(null);
...
function SetupPanel(props) {
  (0, import_react8.useSyncExternalStore)((listener) => props.input?.state.subscribe?.(listener) ?? (() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("header", { className: "qccPwPageHeading", children: [
      ...
      props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "qccPwTaskId", children: taskDisplayLabel(props.task.id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "qccPwCard qccPwSetupCard", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(PrevisitFields, { actions, idPrefix: `qccPw-${props.sessionId}`, sessionId: props.sessionId, send: props.send }) }),
...
function HistoryPanel(props) {
  const [historyPhase, setHistoryPhase] = (0, import_react8.useState)("output");
  (0, import_react8.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "qccPwPanel", children: [
    ...
    props.hosted.length > 0 ? props.hosted.map((item) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "qccPwCardHeader", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { children: taskDisplayLabel(props.task.id) }),
...
function PrevisitWorkbenchTab(props) {
  const sessionId = props.scope.sessionId;
  const shared = (0, import_react8.useSyncExternalStore)(props.shared.subscribe, () => props.shared.get(sessionId));
  ...
  const [runtime, setRuntime] = (0, import_react8.useState)(EMPTY_RUNTIME);
  const [plans, setPlans] = (0, import_react8.useState)([]);
  const [dismissedPlanIds, setDismissedPlanIds] = (0, import_react8.useState)([]);
  const [sessionTasks, setSessionTasks] = (0, import_react8.useState)([]);
  ...
  const lastPlanLocation = (0, import_react8.useRef)();
  const [hostedTask, setHostedTask] = (0, import_react8.useState)(null);
  const [hostedHistory, setHostedHistory] = (0, import_react8.useState)([]);
  const [selectedHistory, setSelectedHistory] = (0, import_react8.useState)(null);
  const [loadingHistoryTaskId, setLoadingHistoryTaskId] = (0, import_react8.useState)();
  const [downloadingTaskId, setDownloadingTaskId] = (0, import_react8.useState)();
  const [hostError, setHostError] = (0, import_react8.useState)();
  const reconcilingReports = (0, import_react8.useRef)(/* @__PURE__ */ new Set());
  const lastHostedLocation = (0, import_react8.useRef)();
  const [completedTaskId, setCompletedTaskId] = (0, import_react8.useState)();
  const [capturedReport, setCapturedReport] = (0, import_react8.useState)(null);
  const [downloadNote, setDownloadNote] = (0, import_react8.useState)();
  ...
  const hostedEvents = (0, import_react8.useMemo)(() => hostedTask === null ? [] : hostedToolEvents(hostedTask), [hostedTask]);
  ...
  const insights = (0, import_react8.useMemo)(() => parseCardInsights(cardText), [cardText]);
  const reportHtml = (0, import_react8.useMemo)(() => cardText === null ? null : buildPrevisitReportHtml(cardText), [cardText]);
  (0, import_react8.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("header", { className: "qccPwHeader", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "qccPwMeta", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "qccPwStatus", "data-status": status, children: STATUS_LABELS[status] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "qccPwSession", children: hostedTask?.planId === void 0 ? `\u5F53\u524D Session \xB7 ${sessionId.slice(0, 12)}` : `\u8BA1\u5212 ${planDone}/${planTotal} \u5BB6\u5DF2\u51FA\u62A5\u544A \xB7 ${planTasks.length} \u5BB6\u5DF2\u5F00\u59CB` })
      ] })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "qccPwBody", children: [
      shared.view === "target" && pendingPlan !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(PlanCard, { plan: pendingPlan, onConfirm: async (message) => {
      ...
      shared.view === "target" && pendingPlan === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SetupPanel, { sessionId, store: props.shared, task, input: resolveSessionInput(props.ctx, sessionId), send: async (prompt) => {
      ...
      shared.view === "scope" ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ScopePanel, { state: shared, task, hostedTask }) : null,
