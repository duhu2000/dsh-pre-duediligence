...
async function resolveSessionId(ctx, service) {
  ...
  const sessionId = ctx.workspaces?.connectWorkspace !== void 0 ? await ctx.workspaces.connectWorkspace(workspaceId) : uiWorkspace?.connectWorkspace !== void 0 ? await uiWorkspace.connectWorkspace(workspaceId) : await ctx.sessions.create?.({ workspaceId });
  if (sessionId === void 0) {
