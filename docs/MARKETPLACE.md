...
| npm | `dsh-pre-duediligence@0.1.28`，发布后核验 `latest=0.1.28` |
| Release | `https://github.com/duhu2000/dsh-pre-duediligence/releases/tag/v0.1.28` |
| 许可证 | MIT |
| Topic | `dsh-plugin` |
...
- 0.1.28 保持显式 TaskScope 与旧记录只读边界，并补齐稳定菜单名、Host 新版首页标题定位及历史详情/报告下载；生产账号端到端复测仍以用户验收为准，市场描述不把待验项写成已通过。
