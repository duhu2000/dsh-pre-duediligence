...
// src/initial-draft.ts
var INITIAL_DRAFT_TEXT = "\u8BF7\u5E2E\u6211\u51C6\u5907\u4E00\u6B21\u5BA2\u6237\u62DC\u8BBF\u3002\u8BF7\u586B\u5199\u4F01\u4E1A\u540D\u79F0\u548C\u5173\u6CE8\u91CD\u70B9\uFF0C\u4E5F\u53EF\u70B9\u51FB\u5DE6\u4E0A\u89D2\u300C\u63D0\u793A\u8BCD\u751F\u6210\u300D\u9009\u62E9\u89D2\u8272\u3001\u62DC\u8BBF\u573A\u666F\u548C\u62A5\u544A\u683C\u5F0F\u3002\u4F8B\u5982\uFF1A\u6211\u662F\u94F6\u884C\u5BA2\u6237\u7ECF\u7406\uFF0C\u51C6\u5907\u62DC\u8BBF\u3010\u4F01\u4E1A\u540D\u79F0\u3011\uFF0C\u91CD\u70B9\u4E86\u89E3\u7ECF\u8425\u60C5\u51B5\u4E0E\u98CE\u9669\uFF0C\u751F\u6210\u8BBF\u524D\u7B80\u62A5\u3002";
var isInitialDraft = (text) => text === INITIAL_DRAFT_TEXT;
var hasUnfilledPlaceholder = (text) => /【[^】]*】/u.test(text);
var attemptedEntries = /* @__PURE__ */ new Set();
async function prefillCreatedPrevisitSession(host, sessionId, entryStillCurrent) {
  ...
  try {
    ...
    const empty = () => {
      ...
      return entryStillCurrent() && s.phase === "plain" && s.draft === "" && s.draftRev === 0 && Array.isArray(attachments) && attachments.length === 0 && Array.isArray(s.occurrences) && s.occurrences.length === 0;
    };
...
function routePrevisitPrompt(text) {
...
function reportTextWithTime(markdown, completedAt) {
...
function parseCardInsights(md) {
  ...
  for (const line of riskSrc.split("\n")) {
    ...
    if (match) risks.push({ level: match[1], text: match[2] });
...
// src/risk-summary.tsx
var import_jsx_runtime2 = require("react/jsx-runtime");
function RiskSummary({ task, insights, running }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "qccPwCard qccPwRiskSummary", "aria-label": "\u98CE\u9669\u7814\u5224\u6458\u8981", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: "\u98CE\u9669\u7814\u5224\u6458\u8981" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "qccPwNote", children: published ? "\u5DF2\u53D1\u5E03\u62A5\u544A\u7ED3\u8BBA\uFF1B\u4E0B\u65B9\u4FDD\u7559\u5728\u7EBF\u6838\u9A8C\u8FC7\u7A0B\u4E0E\u4F9D\u636E\u3002" : available ? "\u9636\u6BB5\u6027\u5224\u65AD \xB7 \u968F\u5DF2\u4FDD\u5B58\u5206\u6790\u8BB0\u5F55\u66F4\u65B0\uFF0C\u5C1A\u975E\u6700\u7EC8\u7ED3\u8BBA\u3002" : running ? "\u98CE\u9669\u5206\u6790\u4E2D\uFF0C\u6682\u672A\u5F62\u6210\u5206\u7EA7\uFF1B\u4E0D\u4EE5\u67E5\u8BE2\u5B8C\u6210\u63A8\u65AD\u65E0\u98CE\u9669\u3002" : "\u5C1A\u672A\u53D6\u5F97\u98CE\u9669\u5206\u7EA7\uFF0C\u4E0D\u4EE3\u8868\u7EA2\u7EBF\u4E3A\u96F6\u3002" }),
    available ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "qccPwRiskTiles", children: ["\u7EA2\u7EBF", "\u5173\u6CE8", "\u4FE1\u606F"].map((level) => {
      ...
      const items = published ? reportRows.filter((row) => isRiskFindingText(row.text) && !/^(?:证据不足|结论未明确|尚未形成|待核验|未完成核验)/.test(row.text)).map((row) => ({ id: row.text, title: "", text: row.text, time: "", refs: [] })) : live.filter((row) => row.riskLevel === level).map((row) => ({ id: row.id, title: row.title, text: row.summary, time: row.updatedAt, refs: row.evidenceIds }));
      const noFinding = published && !unresolved && !items.length && reportRows.some((row) => /^(?:无[。；;]?|本次.*未发现.*|未发现.*|暂无(?:红线|该级别事项).*)$/.test(row.text.trim()));
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "qccPwRiskTile", "data-level": level, "data-clear": noFinding, "data-empty": !items.length, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "qccPwRiskTileTop", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("b", { children: level === "\u7EA2\u7EBF" ? "\u7EA2\u7EBF \xB7 \u4F18\u5148\u6838\u5B9E" : level }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: items.length ? items.length : noFinding ? `\u672C\u6B21\u6838\u9A8C\u672A\u53D1\u73B0${level === "\u7EA2\u7EBF" ? "\u7EA2\u7EBF" : "\u8BE5\u7EA7\u522B\u4E8B\u9879"}` : running && !task?.reportReady ? "\u5206\u6790\u4E2D" : "\u7ED3\u8BBA\u672A\u660E\u786E" })
        ] }),
        items.map((row) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h4", { children: row.title }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: row.text }),
          row.time ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { children: [
            "\u66F4\u65B0\u65F6\u95F4\uFF1A",
            row.time
          ] }) : null,
          row.refs.length ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("details", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("summary", { children: "\u8BC1\u636E\u5F15\u7528" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { children: row.refs.map((ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { children: ref }, ref)) })
          ] }) : null
        ] }, row.id)),
        !items.length ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: noFinding ? "\u672C\u6B21\u62A5\u544A\u660E\u786E\u672A\u53D1\u73B0\u8BE5\u7EA7\u522B\u4E8B\u9879\uFF1B\u4EC5\u9650\u5DF2\u6838\u9A8C\u8303\u56F4\uFF0C\u4E0D\u4EE3\u8868\u98CE\u9669\u7EDD\u5BF9\u4E0D\u5B58\u5728\u3002" : running && !task?.reportReady ? "\u6B63\u5728\u6574\u7406\u8BE5\u7EA7\u522B\u7ED3\u8BBA\u3002" : "\u62A5\u544A\u672A\u63D0\u4F9B\u53EF\u8BC6\u522B\u7684\u8BE5\u7EA7\u522B\u7ED3\u8BBA\uFF0C\u53EF\u67E5\u770B\u539F\u62A5\u544A\u6216\u7EE7\u7EED\u8865\u5145\u6838\u9A8C\uFF1B\u4E0D\u4EE3\u8868\u4EFB\u52A1\u4ECD\u5728\u8FD0\u884C\uFF0C\u4E5F\u4E0D\u80FD\u89E3\u91CA\u4E3A\u96F6\u98CE\u9669\u3002" }) : null
      ] }, level);
    }) }) : null
  ] });
}
...
function hostedLiveProgress(task, now = Date.now()) {
  ...
  const current = running === void 0 ? null : dimensionLabel(running.dimension);
  const title = task.state === "needs-entity-confirmation" ? "\u7B49\u5F85\u786E\u8BA4\u62DC\u8BBF\u5BA2\u6237" : running !== void 0 ? `\u6B63\u5728\u67E5\u8BE2\uFF1A${current}` : task.state === "finalizing" || task.stage === "output" ? "\u6B63\u5728\u751F\u6210\u4E00\u9875\u7EB8\u62A5\u544A" : task.runs.length > 0 ? "\u672C\u8F6E\u67E5\u8BE2\u5DF2\u8FD4\u56DE\uFF0C\u6B63\u5728\u7814\u5224\u4E0E\u6574\u7406" : "\u6B63\u5728\u51C6\u5907\u4F01\u4E1A\u67E5\u8BE2";
...
function syncHostedTaskState(state, record, adopted, locateCurrentStage) {
  ...
  const nextView = locateCurrentStage && !record.reportReady && !HOSTED_TERMINAL.has(record.state) && state.view !== "history" ? state.view === "target" && record.entity && (desiredView === "collect" || desiredView === "verify") ? "scope" : desiredView : state.view;
...
// src/company-portrait-view.tsx
var import_jsx_runtime3 = require("react/jsx-runtime");
function CompanyPortraitView({ portrait, dimension }) {
  const rows = dimension === "registration" ? [["\u767B\u8BB0\u72B6\u6001", portrait.status], ["\u6CE8\u518C\u5730\u533A", portrait.region], ["\u56FD\u6807\u884C\u4E1A", portrait.nationalIndustry], ["\u6CE8\u518C\u8D44\u672C", portrait.capital]] : [["\u4F01\u4E1A\u7B80\u4ECB", portrait.introduction], ["\u4F01\u67E5\u67E5\u884C\u4E1A", portrait.qccIndustry], ["\u4E3B\u8425\u4EA7\u54C1", portrait.products?.length ? portrait.products.join("\u3001") : void 0], ["\u4F01\u4E1A\u89C4\u6A21", portrait.scale], ["\u4F01\u67E5\u67E5\u4EA7\u4E1A\u94FE\u6982\u89C8\uFF08\u6570\u636E\u52A0\u5DE5\u6458\u8981\uFF09", portrait.overview]];
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "qccPwPortrait", children: [
    rows.map(([label, value]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { children: [
    ...
    dimension === "registration" && portrait.areaCode ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("details", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("summary", { children: "\u5730\u533A\u4EE3\u7801" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: portrait.areaCode })
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "qccPwNote", children: dimension === "registration" ? "\u6CE8\u518C\u5730\u533A\u4E0D\u7B49\u4E8E\u5B9E\u9645\u7ECF\u8425\u5730\u70B9\uFF1B\u56FD\u6807\u884C\u4E1A\u4E0E\u4F01\u67E5\u67E5\u884C\u4E1A\u5C5E\u4E8E\u4E0D\u540C\u5206\u7C7B\u4F53\u7CFB\u3002" : "\u4EA7\u54C1\u4E0E\u89C4\u6A21\u4E3A\u6765\u6E90\u753B\u50CF\uFF0C\u4E0D\u4EE3\u8868\u8BA2\u5355\u3001\u8425\u6536\u6216\u4FE1\u7528\u7ED3\u8BBA\uFF1B\u672A\u8FD4\u56DE\u4E0D\u7B49\u4E8E\u4E0D\u5B58\u5728\u3002" })
  ] });
}
...
function CollectionCards({ task, verification = false }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "qccPwSummaryGrid", children: runs.filter((run) => run.status !== "skipped" && run.dimension !== "risk_scan").map((run) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("article", { className: "qccPwCard", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccPwCardHeader", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { children: dimensionLabel(run.dimension) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "qccPwMode", children: TOOL_OUTCOME_LABELS[run.status] })
        ] }),
        run.result?.portrait && ["registration", "profile"].includes(run.dimension) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CompanyPortraitView, { portrait: run.result.portrait, dimension: run.dimension }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: run.result?.summary || (run.status === "no-data" ? "\u672C\u6B21\u67E5\u8BE2\u672A\u53D1\u73B0\u8BB0\u5F55\u3002" : facts.length ? "\u5DF2\u53D6\u5F97\u6765\u6E90\u4FE1\u606F\uFF0C\u5173\u952E\u5B57\u6BB5\u5982\u4E0B\uFF1B\u5C1A\u975E\u6700\u7EC8\u7814\u5224\u3002" : "\u6682\u672A\u63D0\u53D6\u5230\u4E1A\u52A1\u6458\u8981\uFF1B\u4E0D\u4EE3\u8868\u65E0\u6570\u636E\u3002") }),
          highlights.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { children: highlights.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: fact.length > 160 ? fact.slice(0, 160) + "\u2026" : fact }, fact)) }) : null
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "qccPwNote", children: "\u8986\u76D6\u8FB9\u754C\uFF1A\u4EC5\u5C55\u793A\u672C\u6B21\u8FD4\u56DE\u7684\u6458\u8981\u4E0E\u6709\u9650\u6837\u672C\uFF1B\u8BB0\u5F55\u603B\u6570\u4E0D\u7B49\u4E8E\u5DF2\u9010\u6761\u6838\u67E5\u3002\u672A\u5C55\u793A\u5B57\u6BB5\u53EF\u5728\u539F\u4F1A\u8BDD\u5DE5\u5177\u7ED3\u679C\u4E2D\u67E5\u770B\u3002" }),
        run.message ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "qccPwNote", children: run.message }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("details", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "qccPwNote", children: [
            "\u6765\u6E90\uFF1A",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { children: facts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: fact }, fact)) })
        ] })
      ] }, run.id);
    }) }),
    skipped.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("h4", { children: [
        "\u65E0\u9700\u6267\u884C \xB7 ",
        skipped.length,
        " \u9879"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { children: skipped.map((run) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("li", { children: [
        dimensionLabel(run.dimension),
        ["\u98CE\u9669\u626B\u63CF\u4E3A 0\uFF0C\u65E0\u9700\u4E0B\u94BB", "\u626B\u63CF\u8BA1\u6570\u4E3A0\uFF0C\u65E0\u9700\u4E0B\u94BB"].includes(run.message ?? "") ? "\uFF1A\u672C\u6B21\u626B\u63CF\u672A\u53D1\u73B0\u76F8\u5173\u8BB0\u5F55" : null
      ] }, run.id)) })
    ] }) : null
  ] });
}
function AnalysisPanel({ task, kind, legacy = [] }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "qccPwCard", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { children: kind === "verification" ? "\u6838\u9A8C\u53D1\u73B0\u4E0E\u672A\u89E3\u51B3\u4E8B\u9879" : "\u673A\u4F1A\u5047\u8BBE\u4E0E\u8BC1\u636E\u9A8C\u8BC1" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "qccPwNote", children: kind === "verification" ? "\u533A\u5206\u4E8B\u5B9E\u652F\u6301\u3001\u53CD\u8BC1\u4E0E\u8BC1\u636E\u7F3A\u53E3\uFF1B\u6267\u884C\u5B8C\u6210\u4E0D\u7B49\u4E8E\u7ED3\u8BBA\u901A\u8FC7\u3002" : "\u628A\u5DF2\u53D6\u5F97\u7684\u4FE1\u606F\u8F6C\u5316\u4E3A\u53EF\u9A8C\u8BC1\u7684\u62DC\u8BBF\u95EE\u9898\uFF1B\u4E0D\u662F\u6388\u4FE1\u3001\u5408\u4F5C\u6216\u6295\u8D44\u7ED3\u8BBA\u3002" }),
    !records.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: legacy.length ? "\u4EE5\u4E0B\u4EC5\u4E3A\u65E7\u62A5\u544A\u63D0\u53D6\uFF0C\u672A\u4FDD\u5B58\u8FC7\u7A0B\u8BC1\u636E\uFF0C\u4E0D\u6807\u8BB0\u6838\u9A8C\u5B8C\u6210\u3002" : "\u5C1A\u672A\u4FDD\u5B58\u7ED3\u6784\u5316\u5206\u6790\u3002\u67E5\u8BE2\u7ED3\u679C\u53EF\u5148\u67E5\u9605\uFF1B\u4E0D\u4F1A\u4EE5\u5DE5\u5177\u5B8C\u6210\u4EE3\u66FF\u6838\u9A8C\u7ED3\u8BBA\u3002" }) : null,
    !records.length ? legacy.map((row) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { children: [
      row.id,
      " \xB7 ",
      row.text,
      "\uFF08\u5F85\u9A8C\u8BC1\uFF09"
    ] }, row.id)) : null,
    records.map((record) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("article", { className: "qccPwAnalysis", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "qccPwCardHeader", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h4", { children: record.title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "qccPwMode", "data-tone": ["insufficient", "contradicted", "onsite"].includes(record.status) ? "review" : void 0, children: ANALYSIS_STATUSES[record.status] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: record.summary }),
      [["\u652F\u6301", record.support], ["\u53CD\u8BC1", record.counter], ["\u672A\u77E5\u4E0E\u7F3A\u53E3", record.unknown]].map(([label, items]) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: label }),
        items.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { children: items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("li", { children: item }, index)) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "qccPwNote", children: "\u5C1A\u672A\u8BB0\u5F55\uFF08\u4E0D\u4EE3\u8868\u4E0D\u5B58\u5728\uFF09" })
      ] }, label)),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: record.status === "onsite" ? "\u5F85\u5BA2\u6237\u786E\u8BA4\uFF1A" : "\u4E0B\u4E00\u6B65\uFF08\u6309\u8BC1\u636E\u53EF\u5F97\u6027\u7EE7\u7EED\u6838\u9A8C\u6216\u8054\u7CFB\u5BA2\u6237\uFF09\uFF1A" }),
        record.nextAction
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("details", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("summary", { children: [
        ...
        history.filter((row) => row.id === record.id).map((row) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { children: [
            "V",
            row.revision,
            " \xB7 ",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: row.summary }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { children: [
            "\u652F\u6301\uFF1A",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("ul", { children: row.evidenceIds.map((ref) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("li", { children: [
            ref,
            " \xB7 ",
...
function PrevisitLogo(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "svg",
    {
      ...
      "aria-hidden": "true",
      style: props.style,
      children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: PREVISIT_LOGO_PATH })
    }
  );
}
...
async function downloadReportFormat(taskId, sessionId, format) {
...
function ReportFilesPanel({ taskId, sessionId, onHtml }) {
  ...
  const generate = async (format) => {
    ...
    setError("");
    try {
      await downloadReportFormat(taskId, sessionId, format);
    } catch (cause) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwDownloadActions", "aria-label": "\u4E0B\u8F7D\u62A5\u544A", children: [
    onHtml ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "qccPwSecondary", disabled: busy !== null, onClick: onHtml, children: "\u4E0B\u8F7D HTML" }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "qccPwSecondary", disabled: busy !== null, onClick: () => void generate("docx"), children: busy === "docx" ? "\u6B63\u5728\u751F\u6210 Word\u2026" : "\u4E0B\u8F7D Word" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "qccPwPrimary", disabled: busy !== null, onClick: () => void generate("pdf"), children: busy === "pdf" ? "\u6B63\u5728\u751F\u6210 PDF\u2026" : "\u4E0B\u8F7D PDF" }),
    busy ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { role: "status", children: "\u751F\u6210\u5B8C\u6210\u540E\u81EA\u52A8\u4E0B\u8F7D" }) : null,
    error ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { role: "alert", children: error }) : null
  ] });
}
...
function MaterialPanel({ task }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("section", { className: "qccPwCard", "aria-label": "\u8865\u5145\u6750\u6599\u4E0E\u4EA4\u53C9\u6838\u9A8C", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { children: "\u8865\u5145\u6750\u6599\u4E0E\u4EA4\u53C9\u6838\u9A8C" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: "\u6750\u6599\u6B63\u6587\u548C\u6765\u6E90\u4FE1\u606F\u7531\u4F1A\u8BDD\u63D0\u4F9B\uFF0C\u4E0D\u7B49\u4E8E\u5DF2\u9A8C\u8BC1\u771F\u5B9E\u6027\uFF1B\u6765\u6E90\u65E5\u671F\u4E0E\u5BFC\u5165\u65E5\u671F\u5206\u522B\u4FDD\u7559\u3002\u65B0\u589E\u8D44\u6599\u8BF7\u5728\u8865\u5145\u4EFB\u52A1\u4F1A\u8BDD\u4E2D\u63D0\u4EA4\u3002" }),
    task.materials.map((material) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("details", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("p", { style: { overflowWrap: "anywhere" }, children: [
        "SHA256\uFF1A",
        material.sha256
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("pre", { style: { whiteSpace: "pre-wrap", maxHeight: 240, overflow: "auto" }, children: material.text })
    ] }, material.id)),
    (task.evidenceComparisons ?? []).map((comparison) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { role: comparison.status === "conflict" ? "note" : void 0, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("strong", { style: { color: comparison.status === "conflict" ? "#ad6800" : void 0 }, children: labels[comparison.status] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: comparison.id }),
      [comparison.leftId, comparison.rightId].map((id) => {
        const fact = task.evidenceFacts?.find((item) => item.id === id);
        return fact ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("blockquote", { children: [
          fact.field,
          " \xB7 ",
          fact.period,
          " \xB7 ",
          ...
          " \xB7 ",
          fact.location
        ] }, id) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("p", { children: [
          "\u8BC1\u636E\u7F3A\u5931\uFF1A",
          id
        ] }, id);
      })
    ] }, comparison.id)),
    !task.evidenceComparisons?.length ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: "\u5C1A\u672A\u767B\u8BB0\u4EA4\u53C9\u6BD4\u5BF9\uFF0C\u4E0D\u4EE3\u8868\u5DF2\u901A\u8FC7\u53CC\u6E90\u6838\u9A8C\u3002" }) : null
  ] });
}
...
function ImportButton(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { ref: input, type: "file", accept: IMAGE_ACCEPT.join(","), hidden: true, onChange: (event) => {
      props.onFile(event.target.files?.[0]);
      event.target.value = "";
    } }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("button", { type: "button", className: "qccImportBtn", disabled: props.busy, title: props.title ?? "\u5BFC\u5165\u5546\u673A\u56FE\u7247\u6216 PDF\uFF08\u4E5F\u53EF\u4EE5\u76F4\u63A5\u62D6\u5165\u6216\u7C98\u8D34\uFF09", onClick: () => input.current?.click(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M21 12.5 12.5 21a5.5 5.5 0 0 1-7.8-7.8L14 3.9a3.7 3.7 0 0 1 5.2 5.2L9.9 18.4a1.8 1.8 0 0 1-2.6-2.6l8.3-8.3" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: props.busy ? "\u6682\u5B58\u4E2D\u2026" : "\u5BFC\u5165\u56FE\u7247" })
    ] })
  ] });
}
...
function Chips(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "qccDockChips", children: props.options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "qccDockChip", "data-selected": props.selected.includes(option.id), onClick: () => props.onToggle(option.id), children: option.label }, option.id)) });
}
...
function usePrevisitComposer(args) {
  ...
  const startTask = async () => {
    if (inFlight.current || args.blocked || isolated && store.get(sessionId).task !== void 0) return;
...
function PrevisitFields(props) {
  ...
  const st = a.state;
  if (props.locked) return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockBody", role: "status", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { children: "\u4EFB\u52A1\u5DF2\u63D0\u4EA4" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { children: "\u8BF7\u67E5\u770B\u4EFB\u52A1\u8FDB\u5C55\uFF1B\u5982\u9700\u786E\u8BA4\u4E3B\u4F53\uFF0C\u8BF7\u5728\u5BF9\u8BDD\u4E2D\u9009\u62E9\u3002\u65E0\u9700\u91CD\u590D\u63D0\u4EA4\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { children: st.task?.company ?? st.company }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { children: "\u672C\u6B21\u8BBE\u7F6E\u4EE5\u5DF2\u53D1\u9001\u7684\u4EFB\u52A1\u4E3A\u51C6\u3002\u5F00\u59CB\u53E6\u4E00\u9879\u8C03\u67E5\u8BF7\u4F7F\u7528\u300C\u65B0\u7684\u5C3D\u8C03\u300D\u3002" })
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(DropZone, { className: "qccDockBody", onFile: (file) => {
    if (props.send !== void 0) void imports.accept(file);
  }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("label", { className: "qccDockLabel", htmlFor: `${props.idPrefix}-company`, children: "\u62DC\u8BBF\u5BA2\u6237" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockCompanyRow", children: [
        ...
        props.send === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ImportButton, { busy: imports.busy, onFile: (file) => {
          void imports.accept(file);
        } })
      ] })
    ] }),
    imports.status === void 0 && imports.error === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "qccImportState", role: "status", "data-state": imports.error === void 0 ? imports.command?.state : "failed", children: imports.error ?? imports.status }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockLabel", children: "\u6211\u662F" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chips, { options: ROLE_OPTIONS, selected: st.selection.role === void 0 ? [] : [st.selection.role], onToggle: (id) => a.toggleSingle("role", id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockLabel", children: "\u573A\u5408" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chips, { options: PURPOSE_OPTIONS, selected: st.selection.purpose === void 0 ? [] : [st.selection.purpose], onToggle: (id) => a.toggleSingle("purpose", id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockLabel", children: "\u5173\u6CE8" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chips, { options: FOCUS_OPTIONS, selected: st.selection.focus, onToggle: a.toggleFocus })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockLabel", children: "\u6DF1\u5EA6" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chips, { options: BUDGET_OPTIONS, selected: st.selection.budget === void 0 ? [] : [st.selection.budget], onToggle: (id) => a.toggleSingle("budget", id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockLabel", children: "\u8F93\u51FA" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Chips, { options: OUTPUT_OPTIONS, selected: st.selection.output === void 0 ? [] : [st.selection.output], onToggle: (id) => a.toggleSingle("output", id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockFoot", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "qccDockHint", "data-tone": a.error === void 0 ? void 0 : "error", children: a.error ?? (a.isolated ? "\u8BBE\u7F6E\u4EC5\u4FDD\u7559\u5728\u53F3\u4FA7\u5DE5\u4F5C\u53F0\uFF1B\u8F93\u5165\u5B8C\u6574\u540E\u70B9\u51FB\u300C\u5F00\u59CB\u5C3D\u8C03\u300D" : a.manual ? "\u8F93\u5165\u6846\u91CC\u6709\u4F60\u624B\u5199\u7684\u5185\u5BB9\uFF0C\u70B9\u9009\u4E0D\u4F1A\u8986\u76D6\uFF1B\u300C\u6309\u6761\u4EF6\u8865\u5145\u300D\u4F1A\u53E6\u8D77\u4E00\u53E5\u8FFD\u52A0" : "\u6761\u4EF6\u5B9E\u65F6\u5199\u8FDB\u8F93\u5165\u6846\uFF0C\u53EF\u4EE5\u76F4\u63A5\u6539\uFF1B\u6539\u597D\u540E\u70B9\u300C\u5F00\u59CB\u5C3D\u8C03\u300D") }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "qccDockActions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "qccDockBtn", onClick: a.reset, children: "\u6E05\u7A7A" }),
        a.manual ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "qccDockBtn", onClick: a.append, children: "\u6309\u6761\u4EF6\u8865\u5145" }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", className: "qccDockBtn qccDockPrimary", disabled: a.submitting, onClick: () => void a.startTask(), children: a.submitting ? "\u53D1\u9001\u4E2D\u2026" : props.startLabel ?? "\u5F00\u59CB\u5C3D\u8C03 \u2192" })
      ] })
    ] })
  ] });
}
...
function PromptDialog(props) {
  ...
  const dialog = /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "qccPromptBackdrop", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("section", { ref: panelRef, className: "qccPromptPanel", role: "dialog", "aria-modal": "true", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u63D0\u793A\u8BCD\u751F\u6210\u5668", "data-session-id": props.sessionId, tabIndex: -1, children: props.children }) });
...
function OptionGroup(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("fieldset", { className: "qccPromptGroup", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("legend", { children: props.title }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "qccPromptChoices", children: props.options.map((option) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { className: "qccPromptChoice", "data-selected": props.selected.includes(option.id), children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { type: props.multiple === true ? "checkbox" : "radio", name: props.multiple === true ? void 0 : props.title, checked: props.selected.includes(option.id), onChange: () => toggle(option.id) }),
...
function PrevisitPromptGenerator(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "qccPromptLayer", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("button", { ref: triggerRef, type: "button", className: "qccPromptTrigger", "aria-label": "\u6253\u5F00\u8BBF\u524D\u5C3D\u8C03\u63D0\u793A\u8BCD\u751F\u6210\u5668", "aria-expanded": open, onClick: openWizard, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: "m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2zM6 14l.8 2.2L9 17l-2.2.8L6 20l-.8-2.2L3 17l2.2-.8zM18 13l.7 1.8 1.8.7-1.8.7L18 18l-.7-1.8-1.8-.7 1.8-.7z" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: "\u63D0\u793A\u8BCD\u751F\u6210" })
    ] }),
    open && initializedSession === props.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(PromptDialog, { sessionId: props.sessionId, onClose: close, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("header", { className: "qccPromptHead", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h3", { children: "\u751F\u6210\u8BBF\u524D\u5C3D\u8C03\u4EFB\u52A1" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u56DB\u6B65\u660E\u786E\u5BF9\u8C61\u3001\u573A\u666F\u3001\u8303\u56F4\u548C\u8F93\u51FA\uFF1B\u56DE\u586B\u540E\u4ECD\u53EF\u4EBA\u5DE5\u4FEE\u6539\u3002" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: "qccPromptClose", "aria-label": "\u5173\u95ED\u63D0\u793A\u8BCD\u751F\u6210\u5668", onClick: close, children: "\xD7" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "qccPromptBody", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("nav", { className: "qccPromptSteps", "aria-label": "\u4EFB\u52A1\u8BBE\u7F6E\u6B65\u9AA4", children: [[1, "\u62DC\u8BBF\u5BF9\u8C61"], [2, "\u89D2\u8272\u573A\u666F"], [3, "\u8303\u56F4\u6DF1\u5EA6"], [4, "\u786E\u8BA4\u8F93\u51FA"]].map(([index, label]) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("button", { type: "button", "data-active": step === index, "aria-current": step === index ? "step" : void 0, onClick: () => setStep(Number(index)), children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("b", { children: index }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: label })
        ] }, index)) }),
        step === 1 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "qccPromptPane", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h4", { children: "\u660E\u786E\u552F\u4E00\u6CD5\u5F8B\u5B9E\u4F53" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u53EF\u586B\u5199\u4F01\u4E1A\u5168\u79F0\u3001\u7B80\u79F0\u6216\u7EDF\u4E00\u793E\u4F1A\u4FE1\u7528\u4EE3\u7801\uFF1B\u7B80\u79F0\u5B58\u5728\u591A\u5019\u9009\u65F6\uFF0C\u667A\u80FD\u4F53\u4F1A\u5728\u4F1A\u8BDD\u4E2D\u8BF7\u4F60\u786E\u8BA4\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { className: "qccPromptField", children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { children: "\u4F01\u4E1A\u540D\u79F0 / \u4FE1\u7528\u4EE3\u7801" }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("input", { autoFocus: true, value: company, placeholder: "\u4F8B\u5982\uFF1A\u4F01\u67E5\u67E5\u79D1\u6280\u80A1\u4EFD\u6709\u9650\u516C\u53F8", onChange: (event) => setCompany(event.target.value) })
          ] })
        ] }) : null,
        step === 2 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "qccPromptPane", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h4", { children: "\u8BF4\u660E\u4F60\u7684\u89D2\u8272\u548C\u62DC\u8BBF\u573A\u666F" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u9ED8\u8BA4\u91C7\u7528\u94F6\u884C/\u4FE1\u8D37\u5BA2\u6237\u7ECF\u7406\u89C6\u89D2\uFF1B\u53EF\u6309\u672C\u6B21\u62DC\u8BBF\u89D2\u8272\u548C\u573A\u666F\u8C03\u6574\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(OptionGroup, { title: "\u6211\u7684\u89D2\u8272", options: ROLE_OPTIONS, selected: selection.role === void 0 ? [] : [selection.role], onChange: (values) => setSingle(setSelection, "role", values) }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(OptionGroup, { title: "\u62DC\u8BBF\u573A\u666F", options: PURPOSE_OPTIONS, selected: selection.purpose === void 0 ? [] : [selection.purpose], onChange: (values) => setSingle(setSelection, "purpose", values) })
        ] }) : null,
        step === 3 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "qccPromptPane", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h4", { children: "\u9009\u62E9\u5173\u6CE8\u8303\u56F4\u4E0E\u5C3D\u8C03\u6DF1\u5EA6" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u83DC\u5355\u4E0E\u9636\u6BB5\u53EA\u8D1F\u8D23\u5BFC\u822A\uFF1B\u771F\u5B9E\u8986\u76D6\u8303\u56F4\u4EE5\u672C\u6B21\u4F1A\u8BDD\u4E2D\u7684\u5DE5\u5177\u8C03\u7528\u548C\u62A5\u544A\u62AB\u9732\u4E3A\u51C6\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(OptionGroup, { title: "\u91CD\u70B9\u5173\u6CE8", options: FOCUS_OPTIONS, multiple: true, selected: selection.focus, onChange: (values) => setSelection((current) => ({ ...current, focus: values })) }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(OptionGroup, { title: "\u5C3D\u8C03\u6DF1\u5EA6", options: BUDGET_OPTIONS, selected: selection.budget === void 0 ? [] : [selection.budget], onChange: (values) => setSingle(setSelection, "budget", values) })
        ] }) : null,
        step === 4 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "qccPromptPane", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h4", { children: "\u786E\u8BA4\u4EFB\u52A1\u63CF\u8FF0\u548C\u8F93\u51FA" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(OptionGroup, { title: "\u8F93\u51FA\u5F62\u6001", options: OUTPUT_OPTIONS, selected: selection.output === void 0 ? [] : [selection.output], onChange: (values) => setSingle(setSelection, "output", values) }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("pre", { className: "qccPromptPreview", children: generated || "\u586B\u5199\u4F01\u4E1A\u540E\u5C06\u5728\u8FD9\u91CC\u751F\u6210\u4EFB\u52A1\u63CF\u8FF0\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "qccPromptNote", children: "\u56DE\u586B\u4E0D\u4F1A\u542F\u52A8\u5C3D\u8C03\u3002\u53EA\u6709\u70B9\u51FB DSH \u539F\u751F\u53D1\u9001\u6309\u94AE\u540E\uFF0C\u667A\u80FD\u4F53\u624D\u4F1A\u4F7F\u7528\u5F53\u524D\u7528\u6237\u81EA\u5DF1\u7684\u4F01\u67E5\u67E5 MCP \u8FDE\u63A5\u4E0E\u989D\u5EA6\u3002" })
        ] }) : null,
        conflict ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "qccPromptConflict", role: "alertdialog", "aria-label": "\u5904\u7406\u5DF2\u6709\u8F93\u5165\u5185\u5BB9", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("strong", { children: "\u8F93\u5165\u6846\u5DF2\u6709\u5185\u5BB9" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { children: "\u8BF7\u9009\u62E9\u66FF\u6362\u539F\u6587\u3001\u8FFD\u52A0\u4EFB\u52A1\u63CF\u8FF0\uFF0C\u6216\u53D6\u6D88\u5E76\u4FDD\u7559\u5F53\u524D\u5185\u5BB9\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", onClick: () => setConflict(false), children: "\u53D6\u6D88" }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", onClick: () => commit("append"), children: "\u8FFD\u52A0" }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: "is-primary", onClick: () => commit("replace"), children: "\u66FF\u6362" })
          ] })
        ] }) : null,
        error === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "qccPromptError", role: "alert", children: error })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("footer", { className: "qccPromptActions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", disabled: step === 1, onClick: () => {
          setError(void 0);
          setConflict(false);
          setStep((current) => Math.max(1, current - 1));
        }, children: "\u4E0A\u4E00\u6B65" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("button", { type: "button", className: "is-primary", onClick: next, children: step === 4 ? "\u56DE\u586B\u5230\u5BF9\u8BDD\u6846" : "\u4E0B\u4E00\u6B65" })
      ] })
    ] }) : null
  ] });
}
...
function LeftSidebarEntry(props) {
  ...
  const button = /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
    import_dsh_client_ui_primitives.Button,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "qccPrevisitLauncherContent", children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(PrevisitLogo, { size: 18 }),
        wide ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { children: "\u8BBF\u524D\u5C3D\u8C03" }) : null
      ] })
    }
  );
  ...
  ctx.slots.inject("sidebar.footer.action", () => ctx.slots.register({
    ...
    inject: () => ({
      openAgent: async () => {
        ...
        await prefillCreatedPrevisitSession(ctx, sessionId, () => isActive() && ctx.sessions.list?.getSnapshot().current === previous && previous !== sessionId);
...
var PREVISIT_HOME_FLOWS = [
  { view: "target", label: "\u5BF9\u8C61\u4E0E\u76EE\u6807", icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("circle", { cx: "10.5", cy: "10.5", r: "5.5" }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "m15 15 4 4M10.5 7.5v6M7.5 10.5h6" })
  ] }) },
  { view: "scope", label: "\u8303\u56F4\u786E\u8BA4", icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M4 5h16l-6 7v6l-4 2v-8z" }) }) },
  { view: "collect", label: "\u8D44\u6599\u91C7\u96C6", icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M4 20V10h4v10M10 20V4h4v16M16 20v-7h4v7M3 20h18" }) }) },
  { view: "verify", label: "\u8BC1\u636E\u6838\u9A8C", icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M12 3 3.5 7v5c0 4.6 3.1 7.5 8.5 9 5.4-1.5 8.5-4.4 8.5-9V7z" }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M12 8v5M12 17h.01" })
  ] }) },
  { view: "history", label: "\u4EFB\u52A1\u5386\u53F2", icon: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("circle", { cx: "12", cy: "12", r: "9" }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("path", { d: "M12 7v5l3 2" })
  ] }) }
];
function CapabilityIcon({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children });
}
function CapabilityBar(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("nav", { className: "qccPrevisitCapabilities", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u80FD\u529B\u83DC\u5355", children: PREVISIT_HOME_FLOWS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("button", { type: "button", className: "qccPrevisitCapability", "aria-label": item.label, title: item.label, onClick: () => props.onNavigate(item.view), children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(CapabilityIcon, { children: item.icon }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "qccPrevisitCapabilityLabel", children: item.label })
  ] }, item.view)) });
}
...
function PrevisitHome({ sessionId, useSession, openWorkbench: openWorkbench2 }) {
  ...
  if (!enabled) return null;
  const menu = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(CapabilityBar, { onNavigate: (view) => {
    try {
      openWorkbench2?.(view);
      setError(void 0);
    } catch (cause) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { ref: marker, className: `qccPrevisitExperience${blank ? " is-home" : ""}`, "data-session-id": sessionId, children: [
    menuMount === null ? menu : (0, import_react_dom4.createPortal)(menu, menuMount),
    error === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { role: "status", children: error })
  ] });
}
...
function derivePhaseStates(input) {
  ...
  const target = completed.includes("previsit_confirm_entity") ? "done" : entitySeen ? "active" : "idle";
  const scope = completed.includes("previsit_begin") ? "done" : "idle";
  if (!input.hasTask) {
...
.qccPwDownloadActions{display:flex;align-items:center;justify-content:flex-end;gap:8px;flex-wrap:wrap;min-width:0}.qccPwDownloadActions [role="alert"],.qccPwDownloadActions [role="status"]{flex-basis:100%;font-size:12px;overflow-wrap:anywhere}.qccPwDownloadActions [role="alert"]{color:var(--qcc-danger)}.qccPwFooterActions{flex:1;flex-wrap:wrap;justify-content:space-between;min-width:0}.qccPwFooterHint:empty{display:none}.qccPwFooterActions>.qccPwDownloadActions{margin-left:auto}.qccPwDownloadActions button:disabled{opacity:.6;cursor:wait}
...
function Icon({ name }) {
  const paths = {
    target: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "10.5", cy: "10.5", r: "5.5" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "m15 15 4 4M10.5 7.5v6M7.5 10.5h6" })
    ] }),
    scope: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M5 4h14v16H5z" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M8 8h8M8 12h8M8 16h5" })
    ] }),
    collect: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M4 20V10h4v10M10 20V4h4v16M16 20v-7h4v7M3 20h18" }) }),
    verify: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 3 3.5 7v5c0 4.6 3.1 7.5 8.5 9 5.4-1.5 8.5-4.4 8.5-9V7z" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 8v5M12 17h.01" })
    ] }),
    output: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M6 3h8l4 4v14H6z" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M14 3v5h5M9 13h6M9 17h6" })
    ] }),
    clock: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "12", cy: "12", r: "9" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 7v5l3 2" })
    ] }),
    check: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "12", cy: "12", r: "9" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "m8 12 2.5 2.5L16 9" })
    ] }),
    warning: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 3 2.8 20h18.4z" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 9v4M12 17h.01" })
    ] }),
    history: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: "12", cy: "12", r: "9" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M12 7v5l3 2" })
    ] })
  };
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("svg", { className: "qccPwIcon", viewBox: "0 0 24 24", "aria-hidden": "true", children: paths[name] });
}
...
function Feedback(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwFeedback", "data-tone": props.tone, role: props.tone === "error" ? "alert" : "status", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwFeedbackIcon", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Icon, { name: icon }) }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: props.title }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: props.children })
    ] })
  ] });
}
function ExecutionProgress(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwLiveProgress", "data-running": activity.busy, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwLivePulse", "aria-hidden": "true" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwLiveCopy", role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: activity.title }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: activity.detail }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwLiveMetrics", "aria-label": "\u5B9E\u65F6\u6267\u884C\u7EDF\u8BA1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { children: [
        "\u67E5\u8BE2 ",
        progress.queryCount
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { "data-tone": "success", children: [
        "\u95ED\u73AF ",
        progress.completedCount
      ] }),
      progress.noDataCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { "data-tone": "success", children: [
        "\u65E0\u6570\u636E ",
        progress.noDataCount
      ] }) : null,
      progress.skippedCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { "data-tone": "success", children: [
        "\u65E0\u9700\u6267\u884C ",
        progress.skippedCount
      ] }) : null,
      progress.pendingCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { children: [
        "\u5F85\u5904\u7406 ",
        progress.pendingCount
      ] }) : null,
      progress.failedCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { "data-tone": "error", children: [
        "\u5931\u8D25 ",
...
function SetupPanel(props) {
  ...
  const actions = usePrevisitComposer({
    ...
    draftMode: "isolated",
    blocked: props.busy || props.task !== void 0
  });
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwPageHeading", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: "TARGET" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: "\u5BF9\u8C61\u4E0E\u76EE\u6807" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u786E\u8BA4\u62DC\u8BBF\u4E3B\u4F53\u3001\u89D2\u8272\u4E0E\u76EE\u6807\uFF1B\u524D\u7AEF\u4E0D\u9884\u8BBE\u4E1A\u52A1\u7ED3\u8BBA\u3002" })
      ] }),
      props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwTaskId", children: taskDisplayLabel(props.task.id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCard qccPwSetupCard", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PrevisitFields, { actions, locked: props.busy || props.task !== void 0, idPrefix: `qccPw-${props.sessionId}`, sessionId: props.sessionId, send: props.send }) }),
    props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCardHeader", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u5DF2\u53D1\u9001\u7684\u4EFB\u52A1" }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("pre", { className: "qccPwPrompt", children: props.task.prompt })
    ] })
  ] });
}
...
function ScopePanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(StagePanel, { eyebrow: "SCOPE", title: "\u8303\u56F4\u786E\u8BA4", task: props.task, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: "\u8303\u56F4\u662F\u6267\u884C\u610F\u56FE\uFF0C\u4E0D\u662F\u5B8C\u6210\u8BC1\u660E", children: "\u5B9E\u9645\u8986\u76D6\u4EE5\u5F53\u524D\u4F1A\u8BDD\u7684\u4F01\u67E5\u67E5 MCP \u8C03\u7528\u3001\u5931\u8D25\u8BB0\u5F55\u53CA\u62A5\u544A\u8986\u76D6\u8BF4\u660E\u4E3A\u51C6\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCardHeader", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u672C\u6B21\u8BBE\u5B9A" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u9700\u8981\u8C03\u6574\u65F6\u8FD4\u56DE\u300C\u5BF9\u8C61\u4E0E\u76EE\u6807\u300D\uFF0C\u6216\u4F7F\u7528\u8F93\u5165\u6846\u5DE6\u4E0A\u89D2\u7684\u63D0\u793A\u8BCD\u751F\u6210\u5668\u3002" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("dl", { className: "qccPwScopeList", children: rows.map(([label, value]) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("dt", { children: label }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("dd", { children: value })
      ] }, label)) })
    ] })
  ] });
}
function Dimensions(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCardHeader", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: props.title }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwModeGroup", children: [
        done > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "qccPwMode", "data-tone": "success", children: [
          done,
          " \u9879\u5B8C\u6210"
        ] }) : null,
        review > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "qccPwMode", "data-tone": "review", children: [
          review,
          " \u9879\u5F85\u786E\u8BA4"
        ] }) : null,
        blocked > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "qccPwMode", "data-tone": "review", children: [
          blocked,
          " \u9879\u672A\u5B8C\u6210"
        ] }) : null,
        failed > 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "qccPwMode", "data-tone": "error", children: [
          failed,
          " \u9879\u5931\u8D25"
        ] }) : null
      ] })
    ] }),
    props.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEmpty", children: props.empty }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwDims", children: props.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: "qccPwDim", "data-status": item.status, title: item.note, children: [
      item.label,
      " \xB7 ",
...
function StagePanel(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwPageHeading", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: props.eyebrow }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: props.title })
      ] }),
      props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwTaskId", children: taskDisplayLabel(props.task.id) })
    ] }),
    props.children
...
function ScanFindings({ task }) {
  ...
  if (!scan?.result) return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwNote", children: "\u626B\u63CF\u56E0\u5B50\u5C1A\u672A\u4FDD\u5B58\uFF1B\u65E7\u4EFB\u52A1\u8BF7\u53C2\u9605\u62A5\u544A\u4E2D\u7684\u98CE\u9669\u4E0E\u8986\u76D6\u8BF4\u660E\u3002" });
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u67E5\u8BE2\u6210\u529F\u4EC5\u8868\u793A\u6570\u636E\u5DF2\u8FD4\u56DE\uFF0C\u4E0D\u4EE3\u8868\u4F01\u4E1A\u65E0\u98CE\u9669\u3002\u4EE5\u4E0B\u4E3A\u516C\u5F00\u8BB0\u5F55\u8BA1\u6570\uFF0C\u5C1A\u975E\u6700\u7EC8\u98CE\u9669\u5B9A\u6027\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwRiskTiles", children: hits.map((factor) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwRiskTile", "data-level": "\u5173\u6CE8", "data-empty": false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { children: factor.name }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("strong", { children: [
        " \xB7 ",
        factor.count,
        " \u6761"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u5DF2\u53D1\u73B0\u516C\u5F00\u8BB0\u5F55 \xB7 \u9700\u7ED3\u5408\u660E\u7EC6\u7814\u5224" })
    ] }, factor.name)) }),
    factors.length > 0 && hits.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { className: "qccPwNote", children: [
      "\u672C\u6B21\u626B\u63CF ",
      factors.length,
      " \u9879\u5747\u672A\u53D1\u73B0\u516C\u5F00\u8BB0\u5F55\u3002"
    ] }) : null,
    scan.result.summary ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: scan.result.summary }) : null
  ] });
}
function OpportunityPanel(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(StagePanel, { eyebrow: "COLLECT", title: "\u8D44\u6599\u91C7\u96C6", task: props.task, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwNote", children: "\u4EC5\u5C55\u793A\u6765\u6E90\u6570\u636E\u3001\u6837\u672C\u548C\u91C7\u96C6\u8303\u56F4\uFF1B\u7ECF\u8425\u5224\u65AD\u3001\u98CE\u9669\u5206\u7EA7\u4E0E\u673A\u4F1A\u5047\u8BBE\u8BF7\u67E5\u770B\u300C\u8BC1\u636E\u6838\u9A8C\u300D\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Dimensions, { title: "\u91C7\u96C6\u7ED3\u679C", items: opportunityDimensions(props.events), empty: "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A\u91C7\u96C6\u7ED3\u679C" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ScanFindings, { task: props.hostedTask }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u5BA2\u89C2\u6570\u636E\u6458\u8981" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(CollectionCards, { task: props.hostedTask }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u98CE\u9669\u660E\u7EC6\u4E0E\u91C7\u96C6\u8986\u76D6" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(CollectionCards, { task: props.hostedTask, verification: true })
    ] })
  ] });
}
function RiskPanel(props) {
  const { insights } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(StagePanel, { eyebrow: "VERIFY", title: "\u8BC1\u636E\u6838\u9A8C", task: props.task, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(RiskSummary, { task: props.hostedTask, insights, running: props.status === "running" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AnalysisPanel, { task: props.hostedTask, kind: "verification" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u7ECF\u8425\u7814\u5224" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: insights.state ?? (insights.stateUndetermined ? "\u8BC1\u636E\u4E0D\u8DB3\uFF0C\u72B6\u6001\u672A\u5B9A" : "\u5206\u6790\u4E2D\uFF0C\u5C1A\u672A\u5F62\u6210\u7ECF\u8425\u5224\u65AD") }),
      insights.confidence ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { children: [
        "\u7F6E\u4FE1\u5EA6\uFF1A",
        insights.confidence
      ] }) : null,
      insights.industryLink ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { children: [
        "\u7814\u5224\u4E2D\u7684\u4EA7\u4E1A\u94FE\u5B9A\u4F4D\uFF1A",
        insights.industryLink
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(AnalysisPanel, { task: props.hostedTask, kind: "hypothesis", legacy: insights.hypotheses }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("details", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("summary", { children: "\u6267\u884C\u8986\u76D6\u8BF4\u660E\uFF08\u67E5\u8BE2\u72B6\u6001\uFF0C\u4E0D\u4EE3\u8868\u7ED3\u8BBA\u901A\u8FC7\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Dimensions, { title: "\u6267\u884C\u8986\u76D6", items: riskDimensions(props.events), empty: "\u5C1A\u65E0\u6838\u9A8C\u67E5\u8BE2\u8BB0\u5F55" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwNote", children: "\u539F\u59CB\u626B\u63CF\u8BA1\u6570\u548C\u660E\u7EC6\u7EDF\u4E00\u4FDD\u7559\u5728\u300C\u8D44\u6599\u91C7\u96C6\u300D\u3002\u6838\u9A8C\u8BB0\u5F55\u53EF\u5C55\u5F00\u771F\u5B9E\u8BC1\u636E\u5F15\u7528\u4E0E\u4FEE\u8BA2\u5386\u53F2\u3002" })
    ] })
  ] });
}
function ReportViewer(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("iframe", { ref, className: "qccPwReportFrame", title: "\u5C3D\u8C03\u62A5\u544A", sandbox: "allow-same-origin", srcDoc: embedded, onLoad: fit });
}
function DeliveryPanel(props) {
  ...
  if (props.reportHtml !== null) {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwPageHeading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: "OUTPUT" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: "\u8BBF\u524D\u6750\u6599" })
        ] }),
        props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwTaskId", children: taskDisplayLabel(props.task.id) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCard qccPwReportCard", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReportViewer, { html: props.reportHtml }) })
    ] });
  }
  const deliverables = [
    ["\u2460", "\u6838\u5FC3\u7814\u5224", "\u72B6\u6001\u3001\u673A\u4F1A\u65B9\u5411\u4E0E\u9A8C\u8BC1\u91CD\u70B9"],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwPageHeading", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: "OUTPUT" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: "\u8BBF\u524D\u6750\u6599" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u4E0D\u662F\u8D44\u6599\u5806\u780C\uFF0C\u53EA\u56DE\u7B54\u56DB\u4EF6\u4E8B\uFF1A\u53BB\u4E0D\u53BB\u3001\u89C1\u8C01\u3001\u804A\u4EC0\u4E48\u3001\u4EC0\u4E48\u4E0D\u80FD\u78B0\u3002" })
      ] }),
      props.task === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwTaskId", children: taskDisplayLabel(props.task.id) })
    ] }),
    props.task === void 0 ? props.cardCaptured ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "success", title: "\u62A5\u544A\u53EF\u4E0B\u8F7D", children: "\u5F53\u524D\u4F1A\u8BDD\u4E2D\u5DF2\u6709\u5C3D\u8C03\u62A5\u544A\uFF0C\u53EF\u76F4\u63A5\u4E0B\u8F7D\uFF1B\u65B0\u7684\u5C3D\u8C03\u5C06\u91CD\u65B0\u8BA1\u6570\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: "\u7B49\u5F85\u8BBE\u5B9A", children: "\u5B8C\u6210\u5C3D\u8C03\u8BBE\u5B9A\u540E\uFF0C\u62A5\u544A\u7ED3\u6784\u4E0E\u6267\u884C\u8FDB\u5EA6\u4F1A\u663E\u793A\u5728\u8FD9\u91CC\u3002" }) : ready ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "success", title: "\u62A5\u544A\u5DF2\u751F\u6210", children: "\u6267\u884C\u5DF2\u7ED3\u675F\u3002\u53EF\u4E0B\u8F7D\u62A5\u544A\uFF0C\u6216\u56DE\u5230\u4F1A\u8BDD\u67E5\u770B\u5B8C\u6574\u5185\u5BB9\u4E0E\u4E8B\u5B9E\u5F15\u7528\u3002" }) : props.status === "failed" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "error", title: "\u672C\u6B21\u5C3D\u8C03\u672A\u5B8C\u6574\u5B8C\u6210", children: "\u8BF7\u56DE\u5230\u4F1A\u8BDD\u67E5\u770B\u9519\u8BEF\uFF1B\u5DF2\u53D6\u5F97\u4E8B\u5B9E\u4ECD\u53EF\u4FDD\u7559\uFF0C\u5931\u8D25\u7EF4\u5EA6\u4E0D\u5F97\u5199\u6210\u96F6\u8BB0\u5F55\u3002" }) : hostedProgress !== null ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: hostedProgress.title, children: hostedProgress.detail }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: props.status === "running" ? "\u6B63\u5728\u5C3D\u8C03" : "\u7B49\u5F85\u7EE7\u7EED", children: props.status === "running" ? "\u6B63\u5728\u540C\u6B65\u5F53\u524D\u4F1A\u8BDD\u7684\u8D44\u6599\u91C7\u96C6\u4E0E\u8BC1\u636E\u6838\u9A8C\uFF1B\u62A5\u544A\u751F\u6210\u540E\u5373\u53EF\u4E0B\u8F7D\u3002" : "\u8BF7\u56DE\u5230\u4F1A\u8BDD\u7EE7\u7EED\u5F53\u524D\u4EFB\u52A1\uFF1B\u62A5\u544A\u751F\u6210\u540E\u5373\u53EF\u4E0B\u8F7D\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCardHeader", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u62A5\u544A\u7ED3\u6784" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u56FA\u5B9A\u516B\u6BB5\uFF0C\u53EF\u538B\u7F29\u6216\u5C55\u5F00\uFF1B\u4E8B\u5B9E\u3001\u63A8\u7406\u3001\u95EE\u9898\u548C\u8986\u76D6\u8FB9\u754C\u4E0D\u6DF7\u5199\u3002" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwDeliverables", children: deliverables.map(([number, title, detail]) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwDeliverable", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: number }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("b", { children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("small", { children: detail })
        ] })
      ] }, number)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCardHeader", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u6267\u884C\u8986\u76D6" }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u8FD9\u662F\u5DE5\u4F5C\u53F0\u4ECE\u5F53\u524D Session \u8BFB\u53D6\u7684\u771F\u5B9E\u6267\u884C\u4E8B\u4EF6\uFF0C\u4E0D\u662F\u5B8C\u6574\u6027\u8BC4\u5206\u3002" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCoverage", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwMetric", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: props.toolCount }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u4F01\u67E5\u67E5\u67E5\u8BE2\u6B21\u6570\uFF08\u4E0D\u8BBE\u63D2\u4EF6\u4E0A\u9650\uFF09" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwMetric", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: props.failedToolCount }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u5DE5\u5177\u9519\u8BEF" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwMetric", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: ready ? "\u5DF2\u751F\u6210" : "\u5F85\u751F\u6210" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u62A5\u544A\u5236\u54C1\uFF08\u4E0D\u4EE3\u8868\u5168\u91CF\u8986\u76D6\uFF09" })
        ] })
      ] })
    ] })
  ] });
...
function HistoryPanel(props) {
  ...
  if (props.selected !== null) {
    ...
    const reportHtml = selectedReport === void 0 || selectedReport === "" ? null : buildPrevisitReportHtml(selectedReport, item.completedAt ? { generatedAt: item.completedAt } : void 0);
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwPageHeading qccPwHistoryHeading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: "HISTORY DETAIL" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: item.entity?.fullName ?? item.query }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { children: [
            item.id,
            " \xB7 ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "qccPwSecondary", onClick: props.onBack, children: "\u8FD4\u56DE\u6E05\u5355" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCardHeader", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: "\u4EFB\u52A1\u8BE6\u60C5" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwHistorySource", "data-complete": origin.complete, title: origin.label, children: origin.label })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStatus", "data-status": status, children: STATUS_LABELS[status] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { className: "qccPwNote", children: [
          "\u4F01\u67E5\u67E5\u67E5\u8BE2 ",
          item.used,
          " \u6B21 \xB7 ",
        ...
        item.inheritedRuns?.length ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { children: [
          "\u6CBF\u7528 ",
          item.inheritedRuns.length,
          " \u4E2A\u5386\u53F2\u7EF4\u5EA6\uFF0C\u975E\u672C\u6B21\u91CD\u65B0\u67E5\u8BE2\uFF1B\u539F\u67E5\u8BE2\u65E5\u671F\u4FDD\u7559\u5728\u57FA\u7840\u7248\u672C\u3002"
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { "aria-label": "\u62A5\u544A\u7248\u672C\u8BB0\u5F55", children: props.hosted.filter((version) => (version.rootTaskId ?? version.id) === (item.rootTaskId ?? item.id)).sort((a, b) => (a.reportVersion ?? 1) - (b.reportVersion ?? 1)).map((version) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("button", { type: "button", className: "qccPwSecondary", disabled: version.id === item.id, onClick: () => props.onOpen(version), children: [
          "V",
          version.reportVersion ?? 1,
          " \xB7 ",
          version.reportReady ? "\u62A5\u544A\u5DF2\u751F\u6210" : "\u8865\u5145\u4EFB\u52A1\u5904\u7406\u4E2D"
        ] }, version.id)) }),
        props.onContinue && item.reportReady && item.entity ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("label", { children: [
            "\u8865\u5145\u5C3D\u8C03\u8981\u6C42",
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("textarea", { style: { width: "100%", boxSizing: "border-box", minHeight: 80 }, "aria-label": "\u8865\u5145\u5C3D\u8C03\u8981\u6C42", value: intent, maxLength: 4e3, disabled: continuing, onKeyDown: (event) => event.stopPropagation(), onKeyUp: (event) => event.stopPropagation(), onChange: (event) => {
              setIntent(event.target.value);
              continuationId.current = "";
            } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u521B\u5EFA\u72EC\u7ACB\u8865\u5145\u4EFB\u52A1\u548C\u65B0\u7248\u672C\uFF0C\u4E0D\u4FEE\u6539\u539F\u62A5\u544A\u3002\u53EF\u5728\u65B0\u4EFB\u52A1\u4F1A\u8BDD\u63D0\u4EA4\u6750\u6599\u6B63\u6587\u6216\u4F7F\u7528\u5BBF\u4E3B\u53EF\u7528\u6587\u4EF6\u8BFB\u53D6\u80FD\u529B\uFF0C\u767B\u8BB0\u6765\u6E90\u5E76\u4EA4\u53C9\u6BD4\u5BF9\uFF1B\u4E13\u7528\u8206\u60C5\u63A5\u53E3\u548C\u683C\u5F0F\u8F6C\u6362\u5C1A\u672A\u63A5\u5165\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "qccPwPrimary", disabled: continuing || !intent.trim(), onClick: () => {
          ...
          continueError ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { role: "alert", children: continueError }) : null
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwHistoryActions", children: item.reportReady && origin.complete ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReportFilesPanel, { taskId: item.id, sessionId: item.sessionId, onHtml: () => props.onDownload(item) }, item.id) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u62A5\u544A\u5C1A\u672A\u751F\u6210\u6216\u8BB0\u5F55\u6765\u6E90\u4E0D\u5B8C\u6574\uFF0C\u6682\u4E0D\u53EF\u4E0B\u8F7D\u3002" }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("nav", { className: "qccPwStages", "aria-label": "\u5386\u53F2\u4EFB\u52A1\u9636\u6BB5", role: "tablist", children: PREVISIT_PHASES.map((phase) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("button", { type: "button", role: "tab", "aria-selected": historyPhase === phase, className: "qccPwStage", "data-selected": historyPhase === phase, onClick: () => setHistoryPhase(phase), children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStageIcon", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Icon, { name: phase }) }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: PHASE_LABELS[phase] })
      ] }, phase)) }),
      historyPhase === "target" || historyPhase === "scope" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("h3", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u4EC5\u5C55\u793A\u5386\u53F2\u4FDD\u5B58\u5B57\u6BB5\uFF1B\u672A\u4FDD\u5B58\u7684\u89D2\u8272\u3001\u5173\u6CE8\u8303\u56F4\u4E0D\u4F7F\u7528\u5F53\u524D\u4EFB\u52A1\u8865\u586B\u3002" })
      ] }) : null,
      historyPhase === "collect" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(OpportunityPanel, { task: void 0, hostedTask: item, status, events: hostedToolEvents(item), insights: parseCardInsights(selectedReport ?? "") }) : null,
      historyPhase === "verify" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(RiskPanel, { task: void 0, hostedTask: item, status, events: hostedToolEvents(item), insights: parseCardInsights(selectedReport ?? "") }) : null,
      historyPhase !== "output" ? null : reportHtml === null ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: item.reportReady ? "\u6B63\u5728\u8BFB\u53D6\u62A5\u544A" : "\u62A5\u544A\u5C1A\u672A\u751F\u6210", children: item.reportReady ? "\u5DF2\u627E\u5230\u62A5\u544A\u5236\u54C1\uFF0C\u4F46\u6B63\u6587\u6682\u672A\u8FD4\u56DE\uFF1B\u8BF7\u8FD4\u56DE\u6E05\u5355\u540E\u91CD\u8BD5\u3002" : "\u4EFB\u52A1\u8BE6\u60C5\u5DF2\u6062\u590D\uFF0C\u62A5\u544A\u751F\u6210\u540E\u53EF\u5728\u8FD9\u91CC\u67E5\u770B\u5E76\u4E0B\u8F7D\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "qccPwCard qccPwReportCard", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReportViewer, { html: reportHtml }) }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MaterialPanel, { task: item }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwNote", children: "\u5386\u53F2\u8BE6\u60C5\u53EA\u8BFB\u53D6\u8BE5\u4EFB\u52A1\u6240\u5C5E Session \u7684 Host \u5236\u54C1\uFF0C\u4E0D\u4F1A\u91CD\u65B0\u8C03\u7528\u4F01\u67E5\u67E5\uFF0C\u4E5F\u4E0D\u4F1A\u8986\u76D6\u5F53\u524D\u4F1A\u8BDD\u4EFB\u52A1\u3002" })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("header", { className: "qccPwPageHeading", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwEyebrow", children: "HISTORY" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { children: "\u4EFB\u52A1\u5386\u53F2" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: "\u6C47\u603B\u5F53\u524D DSH Profile \u4E2D\u6240\u6709\u8BBF\u524D\u5C3D\u8C03 Session\uFF1B\u4EFB\u52A1\u72B6\u6001\u4E0E\u62A5\u544A\u5236\u54C1\u7531 Host \u4FDD\u5B58\u3002" })
    ] }) }),
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCardHeader", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: item.entity?.fullName ?? item.query }),
                /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("p", { children: [
                  item.id,
                  " \xB7 ",
                  new Date(item.createdAt).toLocaleString("zh-CN")
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwHistoryOpen", children: props.loadingTaskId === item.id ? "\u6B63\u5728\u6253\u5F00\u2026" : origin.complete ? "\u67E5\u770B\u8BE6\u60C5 \u2192" : "\u4EC5\u6458\u8981" })
          ]
        },
        item.id
      );
    }) : props.task === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Feedback, { tone: "notice", title: "\u6682\u65E0\u5386\u53F2\u4EFB\u52A1", children: "\u4ECE\u63D0\u793A\u8BCD\u751F\u6210\u5668\u56DE\u586B\u5E76\u53D1\u9001\uFF0C\u6216\u5728\u4EFB\u4E00\u8BBF\u524D\u4F1A\u8BDD\u4E2D\u76F4\u63A5\u53D1\u8D77\u5C3D\u8C03\u540E\uFF0C\u8FD9\u91CC\u4F1A\u6C47\u603B\u663E\u793A\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCardHeader", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { children: taskDisplayLabel(props.task.id) }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { children: new Date(props.task.createdAt).toLocaleString("zh-CN") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStatus", "data-status": props.status, children: STATUS_LABELS[props.status] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("pre", { className: "qccPwPrompt", children: props.task.prompt })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwNote", children: "\u70B9\u51FB\u4EFB\u52A1\u53EF\u6062\u590D\u8BE6\u60C5\u5E76\u67E5\u770B\u3001\u4E0B\u8F7D\u5DF2\u751F\u6210\u62A5\u544A\uFF1B\u4E0D\u4F1A\u91CD\u65B0\u6267\u884C\u67E5\u8BE2\u3002\u5B8C\u6574\u5BF9\u8BDD\u548C\u8BC1\u636E\u5F15\u7528\u4ECD\u4FDD\u7559\u5728\u5404\u81EA\u7684 DSH \u539F\u751F\u4F1A\u8BDD\u4E2D\u3002" })
  ] });
}
function PrevisitWorkbenchTab(props) {
  ...
  const manualNavigation = (0, import_react9.useRef)(false);
  const navigationTask = (0, import_react9.useRef)();
  const setPhase = (next) => {
  ...
  (0, import_react9.useEffect)(() => {
    ...
    const refresh = async () => {
      try {
        ...
        setHostError(void 0);
        if (record !== null) {
          if (navigationTask.current !== void 0 && navigationTask.current !== record.id) manualNavigation.current = false;
          ...
          const shouldLocate = !manualNavigation.current && awaitingPlan === void 0 && lastHostedLocation.current !== location;
  ...
  const reportHtml = (0, import_react9.useMemo)(() => cardText === null ? null : buildPrevisitReportHtml(cardText, hostedTask?.completedAt ? { generatedAt: hostedTask.completedAt } : void 0), [cardText, hostedTask?.completedAt]);
  const newTask = () => {
  ...
  if (!props.visible || !isPrevisitSession(sessionId)) return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_jsx_runtime13.Fragment, {});
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("header", { className: "qccPwHeader", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwBrand", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwBrandIcon", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PrevisitLogo, { size: 24 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwBrandCopy", children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwTitleRow", children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h1", { className: "qccPwTitle", children: "\u8BBF\u524D\u5C3D\u8C03" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwLiveDot", "data-status": status })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "qccPwSubtitle", children: "\u4F01\u67E5\u67E5\u4E8B\u5B9E\u9A71\u52A8 \xB7 \u673A\u4F1A\u4E0E\u98CE\u9669\u53CC\u5F15\u64CE" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwMeta", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStatus", "data-status": status, children: STATUS_LABELS[status] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwSession", children: hostedTask?.planId === void 0 ? `\u5F53\u524D Session \xB7 ${sessionId.slice(0, 12)}` : `\u8BA1\u5212 ${planDone}/${planTotal} \u5BB6\u5DF2\u51FA\u62A5\u544A \xB7 ${planTasks.length} \u5BB6\u5DF2\u5F00\u59CB` })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("nav", { className: "qccPwTabs", "aria-label": "\u5DE5\u4F5C\u53F0\u89C6\u56FE", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", "data-selected": shared.view !== "history", onClick: () => setView("target"), children: "\u5F53\u524D\u4EFB\u52A1" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", "data-selected": shared.view === "history", onClick: () => setView("history"), children: "\u4EFB\u52A1\u5386\u53F2" })
    ] }),
    shared.view === "history" ? null : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("nav", { className: "qccPwStages", "aria-label": "\u8BBF\u524D\u4EFB\u52A1\u9636\u6BB5", role: "tablist", children: PREVISIT_PHASES.map((current) => {
      const phaseState = phaseStates.find((item) => item.id === current);
      const selected = shared.view === current;
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("button", { type: "button", role: "tab", "aria-selected": selected, className: "qccPwStage", "data-selected": selected, "data-progress": phaseState?.progress ?? "idle", onClick: () => setPhase(current), children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStageIcon", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Icon, { name: current }) }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwStageCopy", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("strong", { children: PHASE_LABELS[current] }) })
      ] }, current);
    }) }),
    shared.view !== "history" && status === "ready" && shared.view !== "output" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwCard", role: "status", children: [
      "\u62A5\u544A\u5DF2\u751F\u6210\uFF0C\u5DF2\u4FDD\u7559\u5F53\u524D\u9605\u8BFB\u9875\u9762\u3002",
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", onClick: () => setPhase("output"), children: "\u67E5\u770B\u62A5\u544A" })
    ] }) : null,
    shared.view !== "history" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ExecutionProgress, { task: hostedTask, status, modelRunning: runtime.available ? runtime.running : void 0, syncError: hostError ?? runtime.lastAgentError ?? void 0 }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwBody", children: [
      shared.view !== "history" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(MaterialPanel, { task: hostedTask }) : null,
      shared.view === "target" && pendingPlan !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PlanCard, { plan: pendingPlan, onConfirm: async (message) => {
      ...
      shared.view === "target" && pendingPlan === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SetupPanel, { busy: runtime.running, sessionId, store: props.shared, task, input: resolveSessionInput(props.ctx, sessionId), send: async (prompt) => {
        await props.startPrompt(sessionId, prompt, true);
      }, start: (prompt) => props.startPrompt(sessionId, prompt), onStarted: () => {
        manualNavigation.current = false;
        setView("target");
      } }) : null,
      shared.view === "scope" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ScopePanel, { state: shared, task, hostedTask }) : null,
      shared.view === "collect" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(OpportunityPanel, { task, hostedTask, status, events: effectiveEvents, insights }) : null,
      shared.view === "verify" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(RiskPanel, { task, hostedTask, status, events: effectiveEvents, insights }) : null,
      shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DeliveryPanel, { task, hostedTask, status, toolCount: hostedTask?.used ?? runtime.toolNames.length, failedToolCount: hostedTask?.runs.filter((run) => run.status === "failed").length ?? runtime.failedToolCount, cardCaptured: cardText !== null, reportHtml }) : null,
      shared.view === "history" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        HistoryPanel,
        {
          task,
          status,
          ...
          onContinue: async (record, intent, requestId) => {
            ...
            props.shared.update(sessionId, (state) => ({ ...state, view: "scope", dismissedTaskIds: [.../* @__PURE__ */ new Set([...state.dismissedTaskIds, ...state.task ? [state.task.id] : [], ...hostedTask ? [hostedTask.id] : []])], task: { id: requestId, prompt, company: record.entity?.fullName ?? record.query, createdAt: (/* @__PURE__ */ new Date()).toISOString(), nodeBaseline: baseline, seenRunning: false, selection: state.selection } }));
          }
        }
      ) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("footer", { className: "qccPwFooter", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "qccPwFooterHint", "data-tone": downloadNote === void 0 && hostError === void 0 ? void 0 : "error", children: downloadNote ?? hostError ?? "" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "qccPwFooterActions", children: [
        shared.view !== "target" && task !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "qccPwSecondary", onClick: newTask, children: "\u65B0\u7684\u5C3D\u8C03" }) : null,
        shared.view === "output" && hostedTask?.reportReady ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReportFilesPanel, { taskId: hostedTask.id, sessionId: hostedTask.sessionId, onHtml: () => {
          void downloadReport();
        } }, hostedTask.id) : shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: "qccPwSecondary", "aria-disabled": status !== "ready" || cardText === null, onClick: () => {
          void downloadReport();
        }, children: "\u4E0B\u8F7D HTML" }) : null
      ] })
    ] })
  ] });
}
...
function apply(ctx) {
  ...
  const submissions = installSubmissionReveal(ctx, (sessionId) => {
    try {
      openForSession(sessionId, "target");
    } catch (cause) {
      unavailableNotice?.remove();
  ...
  ctx.inject(["betterSidebar"], (sidebarCtx) => {
    sidebarCtx.effect(() => {
      ...
      try {
        ...
        const dispose = registerWorkbenchTab(candidate, (props) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PrevisitWorkbenchTab, { ...props, ctx, shared, reveal, startPrompt }, props.scope.sessionId));
        service = candidate;
        return () => {
