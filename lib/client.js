...
function captureTaskReport(snapshot, sessionId, task) {
  ...
  const required = task.prompt.includes("\u9002\u5408\u8F6C\u53D1\u7ED9\u540C\u4E8B\u7684\u7B80\u77ED\u6458\u8981") ? FULL_REPORT_SECTIONS.filter((s) => s !== "\u4E1A\u52A1\u5047\u8BBE" && s !== "\u89E6\u8FBE\u5F00\u573A") : FULL_REPORT_SECTIONS;
...
function PrevisitWorkbenchTab(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwBody", children: [
      ...
      shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DeliveryPanel, { task, status, toolCount: runtime.toolNames.length, failedToolCount: runtime.failedToolCount, cardCaptured: cardText !== null, reportHtml }) : null,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("footer", { className: "qccPwFooter", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwFooterHint", "data-tone": downloadNote === void 0 ? void 0 : "error", children: downloadNote !== void 0 ? downloadNote : "\u5BBF\u4E3B\u6536\u8D77\u4FA7\u62C9\u6216\u5173\u95ED\u672C Tab \u4E0D\u4F1A\u53D6\u6D88\u4EFB\u52A1\uFF0C\u4E5F\u4E0D\u4F1A\u5220\u9664\u5386\u53F2\u6216\u5236\u54C1\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwFooterActions", children: [
        ...
        shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "qccPwPrimary", disabled: status !== "ready" || cardText === null, title: "\u4E0B\u8F7D\u4E3A HTML \u6587\u4EF6\uFF0C\u53EF\u76F4\u63A5\u6253\u5F00\u6216\u6253\u5370", onClick: downloadReport, children: [
          "\u4E0B\u8F7D\u62A5\u544A",
