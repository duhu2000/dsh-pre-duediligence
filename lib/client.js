...
function usePrevisitComposer(args) {
  ...
  const lifetime = (0, import_react.useRef)({ active: true });
...
function PrevisitFields(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "qccDockBody", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "qccDockRow", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { className: "qccDockLabel", htmlFor: `${props.idPrefix}-company`, children: "\u62DC\u8BBF\u5BA2\u6237" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "qccDockFoot", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "qccDockHint", "data-tone": a.error === void 0 ? void 0 : "error", children: a.error ?? (a.isolated ? "\u8BBE\u7F6E\u4EC5\u4FDD\u7559\u5728\u53F3\u4FA7\u5DE5\u4F5C\u53F0\uFF1B\u8F93\u5165\u5B8C\u6574\u540E\u70B9\u51FB\u300C\u5F00\u59CB\u5C3D\u8C03\u300D" : a.manual ? "\u8F93\u5165\u6846\u91CC\u6709\u4F60\u624B\u5199\u7684\u5185\u5BB9\uFF0C\u70B9\u9009\u4E0D\u4F1A\u8986\u76D6\uFF1B\u300C\u6309\u6761\u4EF6\u8865\u5145\u300D\u4F1A\u53E6\u8D77\u4E00\u53E5\u8FFD\u52A0" : "\u6761\u4EF6\u5B9E\u65F6\u5199\u8FDB\u8F93\u5165\u6846\uFF0C\u53EF\u4EE5\u76F4\u63A5\u6539\uFF1B\u6539\u597D\u540E\u70B9\u300C\u5F00\u59CB\u5C3D\u8C03\u300D") }),
...
function PrevisitPromptGenerator(props) {
  ...
  const [selection, setSelection] = (0, import_react2.useState)(() => cloneSelection(EMPTY_SELECTION));
  ...
  const previousSession = (0, import_react2.useRef)(props.sessionId);
  (0, import_react2.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "qccPromptLayer", children: [
    ...
    open && initializedSession === props.sessionId ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(PromptDialog, { sessionId: props.sessionId, onClose: close, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "qccPromptBody", children: [
        ...
        step === 2 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "qccPromptPane", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "\u9ED8\u8BA4\u91C7\u7528\u94F6\u884C/\u4FE1\u8D37\u5BA2\u6237\u7ECF\u7406\u89C6\u89D2\uFF1B\u53EF\u6309\u672C\u6B21\u62DC\u8BBF\u89D2\u8272\u548C\u573A\u666F\u8C03\u6574\u3002" }),
  ...
  const button = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    import_dsh_client_ui_primitives.Button,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "qccPrevisitLauncherContent", children: [
        ...
        wide ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "\u8BBF\u524D\u5C3D\u8C03" }) : null
      ] })
    }
  );
...
var PREVISIT_HOME_FLOWS = [
  { view: "target", label: "\u5BF9\u8C61\u4E0E\u76EE\u6807", icon: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
  ...
  { view: "scope", label: "\u8303\u56F4\u786E\u8BA4", icon: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M4 5h16l-6 7v6l-4 2v-8z" }) }) },
  { view: "collect", label: "\u8D44\u6599\u91C7\u96C6", icon: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("path", { d: "M4 20V10h4v10M10 20V4h4v16M16 20v-7h4v7M3 20h18" }) }) },
  { view: "verify", label: "\u8BC1\u636E\u6838\u9A8C", icon: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
...
function CapabilityBar(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("nav", { className: "qccPrevisitCapabilities", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u80FD\u529B\u83DC\u5355", children: PREVISIT_HOME_FLOWS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { type: "button", className: "qccPrevisitCapability", "aria-label": item.label, title: item.label, onClick: () => props.onNavigate(item.view), children: [
...
function resolvePrevisitHeroChrome(anchor) {
  ...
  const findTitle = (scope2) => {
    ...
    return spans.find((node) => node.dataset.previsitHeroTitle === "true") ?? spans.find((node) => ["\u63A2\u7D22\u672A\u81F3\u4E4B\u5883", "Into the Unknown"].includes(node.textContent?.trim() ?? "")) ?? scope2.querySelector('[class*="headlineText"]');
  };
  if (direct !== null) {
...
function setPrevisitHeadline(anchor) {
  ...
  sync();
  const observationRoot = resolvePrevisitHeroChrome(anchor)?.scope ?? (typeof document === "undefined" ? null : document.body) ?? anchor.parentElement;
...
function PrevisitHome({ sessionId, useSession, openWorkbench: openWorkbench2 }) {
  ...
  if (!enabled) return null;
  const menu = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CapabilityBar, { onNavigate: (view) => {
    try {
      openWorkbench2?.(view);
      setError(void 0);
    } catch (cause) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { ref: marker, className: `qccPrevisitExperience${blank ? " is-home" : ""}`, "data-session-id": sessionId, children: [
    ...
    error === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { role: "status", children: error })
  ] });
}
...
function ExecutionProgress(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwLiveProgress", "data-running": activity.busy, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwLivePulse", "aria-hidden": "true" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwLiveCopy", role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: activity.title }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: activity.detail }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwLiveMetrics", "aria-label": "\u5B9E\u65F6\u6267\u884C\u7EDF\u8BA1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
        "\u67E5\u8BE2 ",
        progress.queryCount
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { "data-tone": "success", children: [
        "\u95ED\u73AF ",
        progress.completedCount
      ] }),
      progress.noDataCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { "data-tone": "success", children: [
        "\u65E0\u6570\u636E ",
        progress.noDataCount
      ] }) : null,
      progress.skippedCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { "data-tone": "success", children: [
        "\u65E0\u9700\u6267\u884C ",
        progress.skippedCount
      ] }) : null,
      progress.pendingCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
        "\u5F85\u5904\u7406 ",
        progress.pendingCount
      ] }) : null,
      progress.failedCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { "data-tone": "error", children: [
        "\u5931\u8D25 ",
...
function SetupPanel(props) {
  (0, import_react6.useSyncExternalStore)((listener) => props.input?.state.subscribe?.(listener) ?? (() => {
...
function Steps(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("ol", { className: "qccPwSteps", children: props.steps.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { className: "qccPwStep", "data-state": step.state, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwStepDot", children: step.state === "done" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { name: "check" }) : step.state === "review" || step.state === "failed" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { name: "warning" }) : index + 1 }),
...
function Dimensions(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwModeGroup", children: [
        done > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", "data-tone": "success", children: [
          done,
          " \u9879\u5B8C\u6210"
        ] }) : null,
        review > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", "data-tone": "review", children: [
          review,
          " \u9879\u5F85\u786E\u8BA4"
        ] }) : null,
        blocked > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", "data-tone": "review", children: [
          blocked,
          " \u9879\u672A\u5B8C\u6210"
        ] }) : null,
        failed2 > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", "data-tone": "error", children: [
          failed2,
          " \u9879\u5931\u8D25"
        ] }) : null
      ] })
    ] }),
    props.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwEmpty", children: props.empty }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "qccPwDims", children: props.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwDim", "data-status": item.status, title: item.note, children: [
      item.label,
      " \xB7 ",
...
function ScanFindings({ task }) {
  ...
  if (!scan?.result) return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwNote", children: "\u626B\u63CF\u56E0\u5B50\u5C1A\u672A\u4FDD\u5B58\uFF1B\u65E7\u4EFB\u52A1\u8BF7\u53C2\u9605\u62A5\u544A\u4E2D\u7684\u98CE\u9669\u4E0E\u8986\u76D6\u8BF4\u660E\u3002" });
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u67E5\u8BE2\u6210\u529F\u4EC5\u8868\u793A\u6570\u636E\u5DF2\u8FD4\u56DE\uFF0C\u4E0D\u4EE3\u8868\u4F01\u4E1A\u65E0\u98CE\u9669\u3002\u4EE5\u4E0B\u4E3A\u516C\u5F00\u8BB0\u5F55\u8BA1\u6570\uFF0C\u5C1A\u975E\u6700\u7EC8\u98CE\u9669\u5B9A\u6027\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "qccPwRiskTiles", children: hits.map((factor) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwRiskTile", "data-level": "\u5173\u6CE8", "data-empty": false, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: factor.name }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("strong", { children: [
        " \xB7 ",
        factor.count,
        " \u6761"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u5DF2\u53D1\u73B0\u516C\u5F00\u8BB0\u5F55 \xB7 \u9700\u7ED3\u5408\u660E\u7EC6\u7814\u5224" })
    ] }, factor.name)) }),
    factors.length > 0 && hits.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "qccPwNote", children: [
      "\u672C\u6B21\u626B\u63CF ",
      factors.length,
      " \u9879\u5747\u672A\u53D1\u73B0\u516C\u5F00\u8BB0\u5F55\u3002"
    ] }) : null,
    scan.result.summary ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: scan.result.summary }) : null
  ] });
}
function OpportunityPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(StagePanel, { eyebrow: "COLLECT", title: "\u8D44\u6599\u91C7\u96C6", task: props.task, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Dimensions, { title: "\u91C7\u96C6\u7ED3\u679C", items: dims, empty: running2 ? "\u6B63\u5728\u5EFA\u7ACB\u4E3B\u4F53\u4E0E\u4FE1\u53F7\u96C6\u2026" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A\u91C7\u96C6\u7ED3\u679C" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ScanFindings, { task: props.hostedTask }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: "\u7ECF\u8425\u4E8B\u5B9E\u4E0E\u7814\u5224" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u4EE5\u4E0B\u5185\u5BB9\u6765\u81EA\u672C\u6B21\u67E5\u8BE2\u8FD4\u56DE\uFF1B\u6700\u7EC8\u7814\u5224\u4E0E\u67E5\u8BE2\u6267\u884C\u72B6\u6001\u5206\u522B\u5C55\u793A\u3002" })
        ] }),
        insights.state !== null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", "data-tone": "success", children: [
          "\u5DF2\u7814\u5224",
          insights.confidence === null ? "" : ` \xB7 \u7F6E\u4FE1\u5EA6 ${insights.confidence}`
        ] }) : insights.stateUndetermined ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwMode", "data-tone": "review", children: "\u72B6\u6001\u672A\u5B9A" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwMode", "data-tone": running2 ? void 0 : "neutral", children: running2 ? "\u6B63\u5728\u7814\u5224" : finished ? "\u672A\u8BC6\u522B\u7ED3\u8BBA" : "\u5F85\u7814\u5224" })
      ] }),
      insights.state ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: insights.state }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u5C1A\u672A\u5F62\u6210\u7ECF\u8425\u7814\u5224\uFF1B\u5148\u5C55\u793A\u5DF2\u8FD4\u56DE\u7684\u7ECF\u8425\u4E8B\u5B9E\uFF0C\u4E0D\u4EE5\u67E5\u8BE2\u6210\u529F\u63A8\u65AD\u7ECF\u8425\u826F\u597D\u3002" }),
      Array.from(new Map((props.hostedTask?.runs ?? []).filter((run) => run.result && (run.result.summary || run.result.facts.length) && ["registration", "profile", "annual_reports", "changes", "financing", "bidding", "recruitment", "investments"].includes(run.dimension)).map((run) => [run.dimension, run])).values()).map((run) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h4", { children: dimensionLabel(run.dimension) }),
        run.result?.summary ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: run.result.summary }) : null,
        run.result?.facts.map((fact) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: fact }, fact))
      ] }, run.id)),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      ...
      insights.hypotheses.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwEmpty", children: finished ? insights.stateUndetermined ? "\u72B6\u6001\u672A\u5B9A\uFF0C\u672A\u751F\u6210\u5047\u8BBE\uFF1B\u76F8\u5173\u672A\u77E5\u5DF2\u8F6C\u5165\u73B0\u573A\u5FC5\u95EE" : insights.found ? "\u62A5\u544A\u4E2D\u672A\u8BC6\u522B\u51FA\u5047\u8BBE" : "\u62A5\u544A\u672A\u6355\u83B7" : running2 ? "\u72B6\u6001\u5224\u5B9A\u540E\u751F\u6210" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("ol", { className: "qccPwHypos", children: insights.hypotheses.map((h) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
...
function RiskPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(StagePanel, { eyebrow: "VERIFY", title: "\u8BC1\u636E\u6838\u9A8C", task: props.task, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Steps, { steps }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Dimensions, { title: "\u6838\u9A8C\u7ED3\u679C", items: dims, empty: running2 ? "\u7B49\u5F85\u98CE\u9669\u626B\u63CF\u2026" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A\u6838\u9A8C\u7ED3\u679C" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ScanFindings, { task: props.hostedTask }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      ...
      !judged ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwEmpty", children: running2 ? "\u626B\u63CF\u4E0E\u4E0B\u94BB\u540E\u7ED9\u51FA\u5206\u7EA7" : finished ? "\u62A5\u544A\u672A\u6355\u83B7" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwRiskTiles", children: [
        ["\u7EA2\u7EBF", "\u5173\u6CE8", "\u4FE1\u606F"].map((level) => {
          const items = real(level);
          const cleared = items.length === 0 && (rows(level).length > 0 || insights.riskNoRecord);
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwRiskTile", "data-level": level, "data-clear": cleared, "data-empty": items.length === 0, children: [
            ...
            items.length ? items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: item.text }, index)) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: cleared ? "\u5DF2\u6838\u67E5\uFF0C\u672C\u6B21\u672A\u53D1\u73B0\u516C\u5F00\u8BB0\u5F55" : "\u672A\u5F62\u6210\u660E\u786E\u7ED3\u8BBA" })
          ] }, level);
        }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwRiskBoundary", children: "\u7EFF\u8272\u8868\u793A\u672C\u6B21\u516C\u5F00\u6570\u636E\u6838\u67E5\u672A\u53D1\u73B0\uFF0C\u4E0D\u4EE3\u8868\u98CE\u9669\u7EDD\u5BF9\u4E0D\u5B58\u5728\u3002" })
      ] })
    ] })
  ] });
}
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCoverage", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwMetric", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u4F01\u67E5\u67E5\u67E5\u8BE2\u6B21\u6570\uFF08\u4E0D\u8BBE\u63D2\u4EF6\u4E0A\u9650\uFF09" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwMetric", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwMetric", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: ready ? "\u5DF2\u751F\u6210" : "\u5F85\u751F\u6210" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u62A5\u544A\u5236\u54C1\uFF08\u4E0D\u4EE3\u8868\u5168\u91CF\u8986\u76D6\uFF09" })
        ] })
      ] })
    ] })
  ] });
...
function HistoryPanel(props) {
  const [historyPhase, setHistoryPhase] = (0, import_react6.useState)("output");
  (0, import_react6.useEffect)(() => {
  ...
  if (props.selected !== null) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwPanel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "qccPwPageHeading qccPwHistoryHeading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwEyebrow", children: "HISTORY DETAIL" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { children: item.entity?.fullName ?? item.query }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { children: [
            item.id,
            " \xB7 ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "qccPwSecondary", onClick: props.onBack, children: "\u8FD4\u56DE\u6E05\u5355" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: "\u4EFB\u52A1\u8BE6\u60C5" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwHistorySource", "data-complete": origin.complete, title: origin.label, children: origin.label })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwStatus", "data-status": status, children: STATUS_LABELS[status] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "qccPwNote", children: [
          "\u4F01\u67E5\u67E5\u67E5\u8BE2 ",
          item.used,
          " \u6B21 \xB7 ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "qccPwHistoryActions", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("nav", { className: "qccPwStages", "aria-label": "\u5386\u53F2\u4EFB\u52A1\u9636\u6BB5", role: "tablist", children: PREVISIT_PHASES.map((phase) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", role: "tab", "aria-selected": historyPhase === phase, className: "qccPwStage", "data-selected": historyPhase === phase, onClick: () => setHistoryPhase(phase), children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwStageIcon", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { name: phase }) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: PHASE_LABELS[phase] })
      ] }, phase)) }),
      historyPhase === "target" || historyPhase === "scope" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h3", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u4EC5\u5C55\u793A\u5386\u53F2\u4FDD\u5B58\u5B57\u6BB5\uFF1B\u672A\u4FDD\u5B58\u7684\u89D2\u8272\u3001\u5173\u6CE8\u8303\u56F4\u4E0D\u4F7F\u7528\u5F53\u524D\u4EFB\u52A1\u8865\u586B\u3002" })
      ] }) : null,
      historyPhase === "collect" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OpportunityPanel, { task: void 0, hostedTask: item, status, events: hostedToolEvents(item), insights: parseCardInsights(selectedReport ?? "") }) : null,
      historyPhase === "verify" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RiskPanel, { task: void 0, hostedTask: item, status, events: hostedToolEvents(item), insights: parseCardInsights(selectedReport ?? "") }) : null,
      historyPhase !== "output" ? null : reportHtml === null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Feedback, { tone: "notice", title: item.reportReady ? "\u6B63\u5728\u8BFB\u53D6\u62A5\u544A" : "\u62A5\u544A\u5C1A\u672A\u751F\u6210", children: item.reportReady ? "\u5DF2\u627E\u5230\u62A5\u544A\u5236\u54C1\uFF0C\u4F46\u6B63\u6587\u6682\u672A\u8FD4\u56DE\uFF1B\u8BF7\u8FD4\u56DE\u6E05\u5355\u540E\u91CD\u8BD5\u3002" : "\u4EFB\u52A1\u8BE6\u60C5\u5DF2\u6062\u590D\uFF0C\u62A5\u544A\u751F\u6210\u540E\u53EF\u5728\u8FD9\u91CC\u67E5\u770B\u5E76\u4E0B\u8F7D\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "qccPwCard qccPwReportCard", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ReportViewer, { html: reportHtml }) }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwNote", children: "\u5386\u53F2\u8BE6\u60C5\u53EA\u8BFB\u53D6\u8BE5\u4EFB\u52A1\u6240\u5C5E Session \u7684 Host \u5236\u54C1\uFF0C\u4E0D\u4F1A\u91CD\u65B0\u8C03\u7528\u4F01\u67E5\u67E5\uFF0C\u4E5F\u4E0D\u4F1A\u8986\u76D6\u5F53\u524D\u4F1A\u8BDD\u4EFB\u52A1\u3002" })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwPanel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("header", { className: "qccPwPageHeading", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u6C47\u603B\u5F53\u524D DSH Profile \u4E2D\u6240\u6709\u8BBF\u524D\u5C3D\u8C03 Session\uFF1B\u4EFB\u52A1\u72B6\u6001\u4E0E\u62A5\u544A\u5236\u54C1\u7531 Host \u4FDD\u5B58\u3002" })
    ] }) }),
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: item.entity?.fullName ?? item.query }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { children: [
                  item.id,
                  " \xB7 ",
                  new Date(item.createdAt).toLocaleString("zh-CN")
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwHistoryOpen", children: props.loadingTaskId === item.id ? "\u6B63\u5728\u6253\u5F00\u2026" : origin.complete ? "\u67E5\u770B\u8BE6\u60C5 \u2192" : "\u4EC5\u6458\u8981" })
          ]
        },
        item.id
      );
    }) : props.task === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Feedback, { tone: "notice", title: "\u6682\u65E0\u5386\u53F2\u4EFB\u52A1", children: "\u4ECE\u63D0\u793A\u8BCD\u751F\u6210\u5668\u56DE\u586B\u5E76\u53D1\u9001\uFF0C\u6216\u5728\u4EFB\u4E00\u8BBF\u524D\u4F1A\u8BDD\u4E2D\u76F4\u63A5\u53D1\u8D77\u5C3D\u8C03\u540E\uFF0C\u8FD9\u91CC\u4F1A\u6C47\u603B\u663E\u793A\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwNote", children: "\u70B9\u51FB\u4EFB\u52A1\u53EF\u6062\u590D\u8BE6\u60C5\u5E76\u67E5\u770B\u3001\u4E0B\u8F7D\u5DF2\u751F\u6210\u62A5\u544A\uFF1B\u4E0D\u4F1A\u91CD\u65B0\u6267\u884C\u67E5\u8BE2\u3002\u5B8C\u6574\u5BF9\u8BDD\u548C\u8BC1\u636E\u5F15\u7528\u4ECD\u4FDD\u7559\u5728\u5404\u81EA\u7684 DSH \u539F\u751F\u4F1A\u8BDD\u4E2D\u3002" })
  ] });
}
function PrevisitWorkbenchTab(props) {
  ...
  const [hostedTask, setHostedTask] = (0, import_react6.useState)(null);
  const [hostedHistory, setHostedHistory] = (0, import_react6.useState)([]);
  const [selectedHistory, setSelectedHistory] = (0, import_react6.useState)(null);
  const [loadingHistoryTaskId, setLoadingHistoryTaskId] = (0, import_react6.useState)();
  const [downloadingTaskId, setDownloadingTaskId] = (0, import_react6.useState)();
  const [hostError, setHostError] = (0, import_react6.useState)();
  const reconcilingReports = (0, import_react6.useRef)(/* @__PURE__ */ new Set());
  const lastHostedLocation = (0, import_react6.useRef)();
  const [completedTaskId, setCompletedTaskId] = (0, import_react6.useState)();
  const [capturedReport, setCapturedReport] = (0, import_react6.useState)(null);
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const refresh = async () => {
      try {
        ...
        if (record === null || !record.reportReady && !HOSTED_TERMINAL.has(record.state)) timer = setTimeout(refresh, 1e3);
      } catch (error) {
        if (!disposed) {
  ...
  const hostedEvents = (0, import_react6.useMemo)(() => hostedTask === null ? [] : hostedToolEvents(hostedTask), [hostedTask]);
  ...
  const reportHtml = (0, import_react6.useMemo)(() => cardText === null ? null : buildPrevisitReportHtml(cardText), [cardText]);
  (0, import_react6.useEffect)(() => {
  ...
  if (!props.visible || !isPrevisitSession(sessionId)) return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, {});
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    ...
    shared.view === "history" ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("nav", { className: "qccPwStages", "aria-label": "\u8BBF\u524D\u4EFB\u52A1\u9636\u6BB5", role: "tablist", children: PREVISIT_PHASES.map((current) => {
    ...
    shared.view !== "history" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ExecutionProgress, { task: hostedTask, status, modelRunning: runtime.available ? runtime.running : void 0, syncError: hostError ?? runtime.lastAgentError ?? void 0 }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwBody", children: [
      shared.view === "target" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SetupPanel, { sessionId, store: props.shared, task, input: resolveSessionInput(props.ctx, sessionId), start: (prompt) => props.startPrompt(sessionId, prompt), onStarted: () => setPhase("collect") }) : null,
      shared.view === "scope" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ScopePanel, { state: shared, task }) : null,
      shared.view === "collect" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OpportunityPanel, { task, hostedTask, status, events: effectiveEvents, insights }) : null,
      shared.view === "verify" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RiskPanel, { task, hostedTask, status, events: effectiveEvents, insights }) : null,
      shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DeliveryPanel, { task, hostedTask, status, toolCount: hostedTask?.used ?? runtime.toolNames.length, failedToolCount: hostedTask?.runs.filter((run) => run.status === "failed").length ?? runtime.failedToolCount, cardCaptured: cardText !== null, reportHtml }) : null,
      shared.view === "history" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        HistoryPanel,
        {
          task,
          status,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("footer", { className: "qccPwFooter", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwFooterHint", "data-tone": downloadNote === void 0 && hostError === void 0 ? void 0 : "error", children: downloadNote ?? hostError ?? "\u5BBF\u4E3B\u6536\u8D77\u4FA7\u62C9\u6216\u5173\u95ED\u672C Tab \u4E0D\u4F1A\u53D6\u6D88\u4EFB\u52A1\uFF0C\u4E5F\u4E0D\u4F1A\u5220\u9664\u5386\u53F2\u6216\u5236\u54C1\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwFooterActions", children: [
        ...
        shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "qccPwPrimary", "aria-disabled": status !== "ready" || cardText === null, title: status === "ready" ? "\u4E0B\u8F7D\u4E3A HTML \u6587\u4EF6\uFF0C\u53EF\u76F4\u63A5\u6253\u5F00\u6216\u6253\u5370" : "\u62A5\u544A\u5C1A\u672A\u5C31\u7EEA\uFF0C\u70B9\u51FB\u67E5\u770B\u539F\u56E0", onClick: () => {
          void downloadReport();
        }, children: [
          "\u4E0B\u8F7D\u62A5\u544A",
  ...
  ctx.inject(["betterSidebar"], (sidebarCtx) => {
    sidebarCtx.effect(() => {
      ...
      try {
        ...
        const dispose = registerWorkbenchTab(candidate, (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PrevisitWorkbenchTab, { ...props, ctx, shared, reveal, startPrompt }, props.scope.sessionId));
        service = candidate;
        return () => {
