...
function RiskSummary({ task, insights, running }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "qccPwCard qccPwRiskSummary", "aria-label": "\u98CE\u9669\u7814\u5224\u6458\u8981", children: [
    ...
    available ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "qccPwRiskTiles", children: ["\u7EA2\u7EBF", "\u5173\u6CE8", "\u4FE1\u606F"].map((level) => {
      ...
      const items = published ? reportRows.filter((row) => isRiskFindingText(row.text)).map((row) => ({ id: row.text, title: "", text: row.text, time: "", refs: [] })) : live.filter((row) => row.riskLevel === level).map((row) => ({ id: row.id, title: row.title, text: row.summary, time: row.updatedAt, refs: row.evidenceIds }));
      const noFinding = published && !items.length && (reportRows.length > 0 || insights.riskNoRecord);
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "qccPwRiskTile", "data-level": level, "data-clear": noFinding, "data-empty": !items.length, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "qccPwRiskTileTop", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: items.length ? items.length : noFinding ? "\u672C\u6B21\u672A\u53D1\u73B0" : "\u5F85\u7814\u5224" })
        ] }),
        ...
        !items.length ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: noFinding ? "\u62A5\u544A\u5728\u672C\u6B21\u8986\u76D6\u8303\u56F4\u5185\u672A\u5217\u51FA\u8BE5\u7EA7\u522B\u4E8B\u9879\uFF1B\u4E0D\u4EE3\u8868\u98CE\u9669\u7EDD\u5BF9\u4E0D\u5B58\u5728\u3002" : "\u5C1A\u65E0\u8BE5\u7EA7\u522B\u5224\u65AD\uFF0C\u4E0D\u80FD\u89E3\u91CA\u4E3A\u96F6\u98CE\u9669\u3002" }) : null
      ] }, level);
    }) }) : null
  ] });
}
...
function ReportFilesPanel({ taskId, sessionId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "qccPwCard", "aria-label": "\u62A5\u544A\u884D\u751F\u6587\u4EF6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { children: "\u62A5\u544A\u884D\u751F\u6587\u4EF6" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { children: "\u8F6C\u6362\u683C\u5F0F\u4E0D\u6539\u53D8\u62A5\u544A\u7248\u672C\u3002\u6B63\u6587\u53CA Markdown \u6807\u8BB0\u4FDD\u7559\uFF0C\u6392\u7248\u4E0D\u7B49\u540C\u4E8E HTML\uFF1BPDF \u9700\u8981\u7BA1\u7406\u5458\u914D\u7F6E\u4E2D\u6587\u5B57\u4F53\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "qccPwSecondary", disabled: busy, onClick: () => void generate("docx"), children: "\u751F\u6210 Word" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "qccPwSecondary", disabled: busy, onClick: () => void generate("pdf"), children: "\u751F\u6210 PDF" }),
    busy ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { role: "status", children: "\u6B63\u5728\u8F6C\u6362\uFF0C\u539F\u62A5\u544A\u4FDD\u6301\u4E0D\u53D8\u2026" }) : null,
    error ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { role: "alert", children: error }) : null,
    files.map((file) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("a", { href: `/previsit/api/tasks/${encodeURIComponent(taskId)}/files/${file.id}?sessionId=${encodeURIComponent(sessionId)}`, download: file.fileName, children: file.fileName }),
      " \xB7 ",
      file.size,
      " \u5B57\u8282"
    ] }, file.id)),
    deliveries.map((d) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { children: [
      "\u4EA4\u4ED8\u7533\u8BF7\uFF1A",
      d.destination,
      " \xB7 \u5F85\u914D\u7F6E\uFF0C\u5C1A\u672A\u4E0A\u4F20"
    ] }, d.id))
...
function OpportunityPanel(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(StagePanel, { eyebrow: "COLLECT", title: "\u8D44\u6599\u91C7\u96C6", task: props.task, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("details", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("summary", { children: "\u98CE\u9669\u660E\u7EC6\u4E0E\u91C7\u96C6\u8986\u76D6" }),
  ...
  if (props.selected !== null) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("section", { className: "qccPwPanel", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "qccPwCard", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "qccPwHistoryActions", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "button",
          {
            type: "button",
      ...
      item.reportReady && origin.complete ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ReportFilesPanel, { taskId: item.id, sessionId: item.sessionId }, item.id) : null,
...
function PrevisitWorkbenchTab(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "qccPwBody", children: [
      shared.view === "output" && hostedTask?.reportReady ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ReportFilesPanel, { taskId: hostedTask.id, sessionId: hostedTask.sessionId }, hostedTask.id) : null,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("footer", { className: "qccPwFooter", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "qccPwFooterHint", "data-tone": downloadNote === void 0 && hostError === void 0 ? void 0 : "error", children: downloadNote ?? hostError ?? "\u5BBF\u4E3B\u6536\u8D77\u4FA7\u62C9\u6216\u5173\u95ED\u672C Tab \u4E0D\u4F1A\u53D6\u6D88\u4EFB\u52A1\uFF0C\u4E5F\u4E0D\u4F1A\u5220\u9664\u5386\u53F2\u6216\u5236\u54C1\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "qccPwFooterActions", children: [
        ...
        shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("button", { type: "button", className: "qccPwPrimary", "aria-disabled": status !== "ready" || cardText === null, title: status === "ready" ? "\u4E0B\u8F7D\u4E3A HTML \u6587\u4EF6\uFF0C\u53EF\u76F4\u63A5\u6253\u5F00\u6216\u6253\u5370" : "\u62A5\u544A\u5C1A\u672A\u5C31\u7EEA\uFF0C\u70B9\u51FB\u67E5\u770B\u539F\u56E0", onClick: () => {
          void downloadReport();
        }, children: [
          "\u4E0B\u8F7D\u62A5\u544A",
