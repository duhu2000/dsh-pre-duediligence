...
基线：远端 main 已只读核验为 fe799ec532ba323828a44ad7c3e6ea9985adc7a1（0.1.26）。本轮新补丁版本为 0.1.27，禁止复用基线 npm 版本。
...
本轮隔离工作树 `/Users/qcc/Documents/Codex/dsh-previsit-home-20260914`；未修改生产 ~/.dsh、开发验证阶段未操作生产；用户随后授权按PR/main CI/新Tag/OIDC流程发布。真正 Host 的 DOM 重挂载、跨四业务切换、HMR 与最终安装包仍需独立验收。
