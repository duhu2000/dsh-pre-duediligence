...
function PrevisitDock(props) {
  const { sessionId, store } = props;
  const draft = props.useInput((s) => s.draft);
  const hasHistory = props.useSession === void 0 ? false : props.useSession((s) => (s.nodes?.length ?? 0) > 0);
  const nodeCount = props.useSession === void 0 ? 0 : props.useSession((s) => s.nodes?.length ?? 0);
  const adoptedId = props.useSession === void 0 ? null : props.useSession((s) => adoptTaskFromSnapshot(s)?.id ?? null);
  const sessionSnap = props.useSession === void 0 ? void 0 : props.useSession((s) => s);
  ...
  const actions = usePrevisitComposer({
    ...
    onStarted: () => {
      setOpen(false);
      props.open("opportunity");
    }
  });
  const { state } = actions;
  (0, import_react.useEffect)(() => {
    if (state.task !== void 0 || adoptedId === null || sessionSnap === void 0) return;
    const adopted = adoptTaskFromSnapshot(sessionSnap);
    if (adopted === null) return;
    store.update(sessionId, (s) => s.task !== void 0 ? s : { ...s, task: { ...adopted, createdAt: (/* @__PURE__ */ new Date()).toISOString(), seenRunning: true, selection: s.selection } });
    setOpen(false);
  }, [adoptedId, nodeCount, state.task]);
  (0, import_react.useEffect)(() => {
    if (actions.error !== void 0) setOpen(true);
  }, [actions.error]);
  ...
  const [modesHost, setModesHost] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => {
  ...
  const modes = modesHost === null ? null : (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiligenceModeBar, { sessionId, store }), modesHost);
  if (!visible) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ref: anchorRef, hidden: true }),
    modes
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { ref: anchorRef, hidden: true }),
    modes,
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "qccDock", "data-open": open, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "qccDockPanel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "qccDockHead", onClick: () => setOpen(!open), "aria-expanded": open, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockBrand", children: "\u8BBF\u524D\u5C3D\u8C03\u63D0\u793A\u8BCD\u751F\u6210" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockSummary", children: actions.summary.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockHint", children: state.task === void 0 ? "\u70B9\u9009\u6761\u4EF6\uFF0C\u81EA\u52A8\u5199\u8FDB\u4E0B\u65B9\u8F93\u5165\u6846" : "\u5C3D\u8C03\u8FDB\u884C\u4E2D \xB7 \u53EF\u518D\u53D1\u8D77\u65B0\u7684" }) : actions.summary.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockTag", children: item }, item)) }),
        open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockWorkbench", role: "button", tabIndex: 0, title: "\u6253\u5F00\u53F3\u4FA7\u5DE5\u4F5C\u53F0", onClick: (e) => {
          e.stopPropagation();
          props.open();
        }, onKeyDown: (e) => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "qccDockChevron", "aria-hidden": "true" })
      ] }),
      open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PrevisitFields, { actions, idPrefix: `qccDock-${sessionId}` }) : null
    ] }) })
  ] });
}
var MODES = [
...
function DiligenceModeBar(props) {
  const state = (0, import_react.useSyncExternalStore)(props.store.subscribe, () => props.store.get(props.sessionId), () => EMPTY_SESSION_STATE);
  const choose = (id) => props.store.update(props.sessionId, (s) => ({ ...s, panel: s.panel === id ? null : id }));
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "qccModes", role: "group", "aria-label": "\u5C3D\u8C03\u7C7B\u578B", children: MODES.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "qccMode", "data-active": state.panel === m.id, disabled: !m.enabled, "data-tip": m.tip, title: m.tip, onClick: () => choose(m.id), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: m.icon }) }),
...
function PrevisitWorkbenchTab(props) {
  ...
  const [revealedTaskId, setRevealedTaskId] = (0, import_react3.useState)();
  const [cardText, setCardText] = (0, import_react3.useState)(null);
  const [downloadNote, setDownloadNote] = (0, import_react3.useState)();
  (0, import_react3.useEffect)(() => props.navigation.attach(sessionId, setPhase), [props.navigation, sessionId]);
  (0, import_react3.useEffect)(() => {
...
var COMPACT_KEY = "qcc-previsit.compactProcess";
function readCompact() {
  try {
    return (localStorage.getItem(COMPACT_KEY) ?? "1") !== "0";
  } catch {
    return true;
  }
}
...
function CompactToggle() {
  const [on, setOn] = (0, import_react3.useState)(readCompact);
  (0, import_react3.useEffect)(() => {
    applyCompact(on);
  }, [on]);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "qccPwCompact", "data-on": on, title: on ? "\u53EA\u663E\u793A\u6BCF\u8F6E\u6700\u540E\u4E00\u6B65\u4E0E\u7ED3\u8BBA\uFF1B\u70B9\u51FB\u67E5\u770B\u5168\u90E8\u8FC7\u7A0B" : "\u663E\u793A\u5168\u90E8\u5DE5\u5177\u8C03\u7528\u4E0E\u601D\u8003\uFF1B\u70B9\u51FB\u7CBE\u7B80", onClick: () => setOn(!on), children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "data-active": on, children: "\u7CBE\u7B80" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("i", {}),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { "data-active": !on, children: "\u5B8C\u6574" })
  ] });
}
function patchHeroHeadline(ctx, headline) {
  const restore = [];
  try {
  ...
  if (typeof document !== "undefined" && typeof MutationObserver !== "undefined") {
    const fix = () => {
      for (const el of Array.from(document.querySelectorAll('[class*="headlineText"]'))) {
...
function apply(ctx) {
  ...
  ctx.effect(() => registerWorkbenchTab(service, (props) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PrevisitWorkbenchTab, { ...props, ctx, reveal, navigation, shared, startPrompt })), "qcc-previsit: Better Sidebar tab");
  ctx.slots.inject("conversation.input.dock", () => ctx.slots.register({
    ...
    inject: (sessionId) => ({
      store: shared,
      start: (prompt) => startPrompt(sessionId, prompt),
      open: (phase) => {
        openSession(sessionId, phase);
      }
    })
  }, PrevisitDock));
  ...
  ctx.effect(() => {
    ...
    return () => {
      document.documentElement.removeAttribute("data-qcc-compact");
    };
  }, "qcc-previsit: compact process");
}
