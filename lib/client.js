...
var COMPLETE_OUTCOMES = /* @__PURE__ */ new Set(["done", "no-data"]);
...
.qccPwStageIcon{display:grid;place-items:center;width:30px;height:30px;border:1px solid var(--qcc-border);border-radius:7px;background:var(--qcc-surface);flex:0 0 30px}.qccPwStage[data-selected="true"] .qccPwStageIcon,.qccPwStage[data-progress="active"] .qccPwStageIcon{border-color:var(--qcc-brand);background:var(--qcc-selected);color:var(--qcc-action)}.qccPwStage[data-progress="done"] .qccPwStageIcon{border-color:var(--qcc-success);background:var(--qcc-success-bg);color:var(--qcc-success)}.qccPwStage[data-progress="review"] .qccPwStageIcon{border-color:var(--qcc-review);background:var(--qcc-review-bg);color:var(--qcc-review)}.qccPwStage[data-progress="failed"] .qccPwStageIcon{border-color:var(--qcc-danger);background:var(--qcc-danger-bg);color:var(--qcc-danger)}.qccPwStage[data-progress="done"]:not([data-selected="true"]){color:var(--qcc-success)}.qccPwStage[data-progress="review"]:not([data-selected="true"]){color:var(--qcc-review)}.qccPwStage[data-progress="failed"]:not([data-selected="true"]){color:var(--qcc-danger)}
...
.qccPwDims{display:flex;flex-wrap:wrap;gap:7px}.qccPwDim{padding:5px 8px;border:1px solid var(--qcc-border);border-radius:7px;color:var(--qcc-secondary);font-size:11px}.qccPwDim[data-status="done"],.qccPwDim[data-status="no-data"]{border-color:var(--qcc-success);background:var(--qcc-success-bg);color:var(--qcc-success)}.qccPwDim[data-status="running"]{border-color:var(--qcc-brand);background:var(--qcc-selected);color:var(--qcc-action)}.qccPwDim[data-status="unknown"],.qccPwDim[data-status="no-permission"]{border-color:var(--qcc-review);background:var(--qcc-review-bg);color:var(--qcc-review)}.qccPwDim[data-status="failed"]{border-color:var(--qcc-danger);background:var(--qcc-danger-bg);color:var(--qcc-danger)}.qccPwDim[data-status="not-executed"]{border-style:dashed;background:var(--qcc-page)}
...
var completed = (events, fragments) => events.some((e) => fragments.some((f) => e.name.includes(f)) && (e.status === "done" || e.status === "no-data"));
var reviewing = (events, fragments) => events.some((e) => fragments.some((f) => e.name.includes(f)) && (e.status === "unknown" || e.status === "no-permission"));
...
function riskSteps(events, insights, finished) {
  ...
  return [
    ...
    { label: "\u660E\u7EC6\u4E0B\u94BB", state: stepOf(drillDone, running(events, DRILL), reviewing(events, DRILL), failed(events, DRILL)), note: !drillDone && finished ? "\u672A\u89C1\u660E\u7EC6\u67E5\u8BE2\u5B8C\u6210\u8BC1\u636E" : void 0 },
    { label: "\u8463\u76D1\u9AD8", state: stepOf(execDone, running(events, executiveTools), reviewing(events, executiveTools), failed(events, executiveTools)), note: !execDone && finished ? "\u672A\u5355\u72EC\u626B\u63CF" : void 0 },
...
function Dimensions(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
      ...
      done > 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwMode", children: [
        done,
        " \u9879\u5B8C\u6210"
    ...
    props.items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "qccPwEmpty", children: props.empty }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "qccPwDims", children: props.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwDim", "data-status": item.status, children: [
      item.label,
      " \xB7 ",
...
function OpportunityPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(StagePanel, { eyebrow: "COLLECT", title: "\u8D44\u6599\u91C7\u96C6", task: props.task, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Dimensions, { title: "\u5DF2\u53D6\u5F97", items: dims, empty: running2 ? "\u6B63\u5728\u5EFA\u7ACB\u4E3B\u4F53\u4E0E\u4FE1\u53F7\u96C6\u2026" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A\u53D6\u5F97\u7684\u7EF4\u5EA6" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCardHeader", children: [
...
function RiskPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(StagePanel, { eyebrow: "VERIFY", title: "\u8BC1\u636E\u6838\u9A8C", task: props.task, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Steps, { steps }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Dimensions, { title: "\u5DF2\u6838\u67E5", items: dims, empty: running2 ? "\u7B49\u5F85\u98CE\u9669\u626B\u63CF\u2026" : "\u5C3D\u8C03\u5F00\u59CB\u540E\u663E\u793A\u6838\u67E5\u7684\u7EF4\u5EA6" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCard", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwCoverage", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwMetric", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: props.toolLimit === void 0 ? props.toolCount : `${props.toolCount}/${props.toolLimit}` }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u4F01\u67E5\u67E5\u989D\u5EA6\u8C03\u7528" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwMetric", children: [
...
function PrevisitWorkbenchTab(props) {
  ...
  const hostedEvents = (0, import_react6.useMemo)(() => hostedTask === null ? [] : [
    { name: "previsit_begin", status: "done" },
    ...hostedTask.entity === void 0 ? [] : [{ name: "previsit_confirm_entity", status: "done" }],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "qccPwBody", children: [
      ...
      shared.view === "collect" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OpportunityPanel, { task, status, events: effectiveEvents, insights }) : null,
      shared.view === "verify" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(RiskPanel, { task, status, events: effectiveEvents, insights }) : null,
      shared.view === "output" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DeliveryPanel, { task, hostedTask, status, toolCount: hostedTask?.used ?? runtime.toolNames.length, ...hostedTask === null ? {} : { toolLimit: hostedTask.limit }, failedToolCount: hostedTask?.runs.filter((run) => run.status === "failed").length ?? runtime.failedToolCount, cardCaptured: cardText !== null, reportHtml }) : null,
