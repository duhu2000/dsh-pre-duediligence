...
| npm | `dsh-pre-duediligence@0.1.22`，发布后核验 `latest=0.1.22` |
| Release | `https://github.com/duhu2000/dsh-pre-duediligence/releases/tag/v0.1.22` |
| 许可证 | MIT |
| Topic | `dsh-plugin` |
...
- 0.1.22 已补齐跨访前 Session 的 Host 历史汇总，同时保持当前任务严格按 Session 隔离，并完成自动化契约、构建和隔离 UI 回归；生产账号端到端复测仍以用户验收为准，市场描述不把待验项写成已通过。
