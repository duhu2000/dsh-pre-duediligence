...
| npm | `dsh-pre-duediligence@0.1.29`，发布后核验 `latest=0.1.29` |
| Release | `https://github.com/duhu2000/dsh-pre-duediligence/releases/tag/v0.1.29` |
| 许可证 | MIT |
| Topic | `dsh-plugin` |
...
- 0.1.29 保持显式 TaskScope 与旧记录只读边界，新增图片导入、多企业计划及独立报告，保留 Host 持久化、工作台展开与报告核验；生产账号端到端复测仍以用户验收为准，市场描述不把待验项写成已通过。
