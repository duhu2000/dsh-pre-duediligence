...
function OpportunityPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(StagePanel, { eyebrow: "COLLECT", title: "\u8D44\u6599\u91C7\u96C6", task: props.task, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "qccPwCard", children: [
      ...
      Array.from(new Map((props.hostedTask?.runs ?? []).filter((run) => run.result && (run.result.summary || run.result.facts.length) && ["registration", "profile", "annual_reports", "changes", "financing", "bidding", "recruitment", "investments"].includes(run.dimension)).map((run) => [run.dimension, run])).values()).map((run) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
