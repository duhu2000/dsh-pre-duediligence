...
function CapabilityBar(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("nav", { className: "qccPrevisitCapabilities", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u80FD\u529B\u83DC\u5355", children: CAPABILITIES.map((item) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { type: "button", className: "qccPrevisitCapability", onClick: () => props.onNavigate(item.view), children: [
...
.qccPwStages{display:grid;grid-template-columns:repeat(5,minmax(94px,1fr));gap:0;padding:10px 12px;border-bottom:1px solid var(--qcc-border);background:var(--qcc-surface);overflow-x:auto;flex:none}
.qccPwStage{display:flex;align-items:center;gap:8px;min-width:94px;padding:9px 8px;border:1px solid transparent;border-radius:9px;background:transparent;color:var(--qcc-secondary);font:inherit;text-align:left;cursor:pointer}.qccPwStage:hover{background:var(--qcc-page)}.qccPwStage[data-selected="true"]{border-color:var(--qcc-brand);background:var(--qcc-selected);color:var(--qcc-action)}
.qccPwStageIcon{display:grid;place-items:center;width:27px;height:27px;border-radius:7px;background:var(--qcc-page);flex:none}.qccPwStage[data-progress="done"] .qccPwStageIcon{background:var(--qcc-success-bg);color:var(--qcc-success)}.qccPwStage[data-progress="failed"] .qccPwStageIcon{background:var(--qcc-danger-bg);color:var(--qcc-danger)}
...
.qccPwStageCopy{display:grid;gap:2px;min-width:0}.qccPwStageCopy strong{font-size:11px;white-space:nowrap}.qccPwStageCopy small{font-size:9px;white-space:nowrap;color:inherit;opacity:.8}
...
function PrevisitWorkbenchTab(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "qccPwShell", "aria-label": "\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", "data-status": status, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("nav", { className: "qccPwStages", "aria-label": "\u8BBF\u524D\u4EFB\u52A1\u9636\u6BB5", children: PREVISIT_PHASES.map((current) => {
      const phaseState = phaseStates.find((item) => item.id === current);
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "qccPwStage", "data-selected": shared.view === current, "data-progress": phaseState?.progress ?? "idle", onClick: () => setPhase(current), children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "qccPwStageIcon", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { name: current }) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "qccPwStageCopy", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: PHASE_LABELS[current].label }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("small", { children: PHASE_LABELS[current].description })
        ] })
      ] }, current);
    }) }),
...
function PrevisitHeaderEntry(props) {
  if (!isPrevisitSession(props.sessionId)) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "button", className: "qccPrevisitHeaderAction", "aria-label": "\u6253\u5F00\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", title: "\u6253\u5F00\u8BBF\u524D\u5C3D\u8C03\u5DE5\u4F5C\u53F0", onClick: props.openWorkbench, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(PrevisitLogo, { size: 16 }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u8BBF\u524D\u5C3D\u8C03" })
  ] });
}
function apply(ctx) {
  ...
  ctx.slots.inject("conversation.session.header.actions", () => ctx.slots.register({
    ...
    order: 110,
    inject: (sessionId) => ({ openWorkbench: () => {
