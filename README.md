...
版本：**0.1.11**。本版按 DSH-UX-001 v1.5.0 收敛 Better Sidebar 容器与流程定位，已通过本地自动化门禁；DSH `0.1.2-rc.1` / Sidebar `0.18.1` 的候选组合已完成隔离真实宿主无付费交互验收，企查查 Provider 和四款业务插件共装仍待验收。npm 发布与组合验收是独立状态。详见 [更新日志](CHANGELOG.md)、[采用记录](docs/DSH-UX-001-ADOPTION.md)、[兼容与验收矩阵](docs/COMPATIBILITY.md)和[市场投稿登记](docs/MARKETPLACE.md)。
